...
const DIALOGUE_BANK = {
  NUKE_CRAFT: {
    ...
    kind: [
      "Oh dear, my scientists made a [weapon_type]... I hope I never have to use it! ðŸŒ¸ðŸ˜¢",
      "A [weapon_type] is finished, but please let's stay friendly so it stays locked away! âœ¨",
      "I made a [weapon_type] for safety, but I promise I only want peace! ðŸ’›",
      "Oh my, such a scary weapon! Let's keep our borders happy and quiet! ðŸ˜ŠðŸŒ¸",
      "We have a [weapon_type] now, but sending warm hugs in hopes of peace! ðŸŒ¸",
      "Please don't be frightened! I only built this [weapon_type] to protect our sweet home! âœ¨",
      "A [weapon_type] is ready, but I truly hope we can resolve our battles with hugs instead! ðŸ’›",
      "Oh dear! Our silo is loaded, but my little soldiers promise to keep the peace! ðŸ˜Š",
      "A [weapon_type] assembled... Please let's all be nice neighbors! ðŸŒ¸",
      "I built a [weapon_type] for defense, but my heart wishes for eternal peace! âœ¨",
      "Payload ready, but let's stay sweet friends so nobody gets hurt! ðŸ’›",
      "Oh, goodness! Such great power, but sending peaceful wishes to all! ðŸ˜ŠðŸŒ¸"
    ],
    goofball: [
      "Lmao look what I just built! Who gave me access to uranium fr fr? ðŸ’€ðŸ˜‚",
      "Boom button unlocked! Time to cook up some radioactive chaos lmao! ðŸ˜­",
      "I just crafted a [weapon_type], nobody make any sudden moves haha! ðŸ’€",
      "Lmfao my little dudes just built a literal [weapon_type], hide your bases! ðŸ˜‚",
      "Bro, I have weapons of mass destruction now, easiest game of my life! ðŸ’€",
      "No cap, I'm pressing buttons I shouldn't be pressing haha! [weapon_type] ready! ðŸ˜­",
      "Uranium acquired! Time to turn this lobby into a glowing rave party lmfao! ðŸ˜‚",
      "Lmao I am officially a nuclear superpower, please respect my authoritah! ðŸ’€",
      "Oof, just built a [weapon_type]. Hope I don't drop it on my own toes haha! ðŸ˜­",
      "Silo loaded! Watch out guys, my finger is literally twitching on the launch button! ðŸ˜‚",
      "Lmfao [weapon_type] crafted. Someone get the popcorn ready! ðŸ’€",
      "No cap, big boom incoming soon! Stay tuned chat! ðŸ˜­ðŸ˜‚"
    ],
    cynical: [
  ...
  NUKE_LAUNCH: {
    ...
    kind: [
      "Oh no! I am so sorry, @[recipient]! The missile had to target [requested_territory]! ðŸ˜¢ðŸŒ¸",
      "Please forgive me! I had to launch on [requested_territory] to keep my people safe! ðŸ’”",
      "It hurts my heart to use such power on [requested_territory], but the war forced my hand! ðŸ˜¢",
      "Sending warm thoughts through the smoke! I'm so sorry about [requested_territory], friend! ðŸŒ¸",
      "Oh dear! Such terrible devastation at [requested_territory]... Please stay safe! ðŸ’›",
      "Forgive my strike on [requested_territory], @[recipient]! We had no other choice! ðŸ˜¢",
      "My heart breaks for the soldiers at [requested_territory]! Please forgive our strike! ðŸŒ¸",
      "Oh, goodness! [requested_territory] is in ruins... I am so sorry, dear neighbor! ðŸ’›",
      "A tragic strike on [requested_territory], but we must protect our home garden! ðŸ˜¢ðŸŒ¸",
      "Please don't hate me, @[recipient]! [requested_territory] had to be neutralized! âœ¨",
      "Sending peaceful prayers after the blast at [requested_territory]! ðŸ’›",
      "Such a scary explosion at [requested_territory]! I hope we can still find peace soon! ðŸ˜ŠðŸŒ¸"
    ],
    goofball: [
      "BOOM! Nuclear delivery for @[recipient] at [requested_territory]! Enjoy the fireworks! ðŸ’€ðŸ˜‚",
      "Lmao RIP to [requested_territory], bro got absolute-unit vaporized fr fr! ðŸ˜­ðŸ’€",
      "Oops! My finger slipped on the red button and deleted [requested_territory] lmfao! ðŸ˜‚",
      "Nuclear strike landed! [requested_territory] has officially left the server haha! ðŸ’€",
      "Lmfao look at that mushroom cloud over [requested_territory]! Absolutely cinematic! ðŸ˜‚",
      "No cap, [requested_territory] is glowing green now! Easiest wipe of my life! ðŸ˜­",
      "Special delivery at [requested_territory]! Sparing your stack was not on the menu bro! ðŸ˜‚",
      "Lmao GG to [requested_territory], hope your troops packed some sunscreen haha! ðŸ’€",
      "Bro, [requested_territory] just got deleted in 4K! Hope you like ash ruins! ðŸ˜­ðŸ˜‚",
      "Tactical nuke incoming! [requested_territory] has entered the shadow realm lmfao! ðŸ’€",
      "Lmfao boom goes the dynamite! Bye bye [requested_territory]! ðŸ˜‚",
      "Nuclear party at [requested_territory]! Everyone is invited to spectate the crater! ðŸ’€ðŸ˜­"
    ],
    cynical: [
  ...
  ALLIANCE_ACCEPT: {
    ...
    kind: [
      "Oh, thank you, @[sender]! Let's protect each other from @[subject]! ðŸ˜Š",
      "I gladly accept! Let's be great partners and keep our lands safe from @[subject]! âœ¨",
      "This is wonderful! Together we can stand strong against @[subject]'s attacks. ðŸ‘",
      "Agreed! I promise to be a helpful and kind ally to you against @[subject]! ðŸŒ¸",
      "Yay! Let's look out for one another and stop @[subject] from taking over. ðŸ’›",
      "I accept! Let's keep the peace on our borders while we deal with @[subject]. ðŸ˜Š",
      "An alliance with you sounds lovely, @[sender]. Let's protect our homes from @[subject]!",
      "Let's help each other out! @[subject] won't be able to break our joint defenses. âœ¨",
      "Oh, how exciting! Let's work together happily and keep @[subject] from being mean! ðŸ˜ŠðŸŒ¸",
      "I'm so glad we are partners now, @[sender]! Let's make sure @[subject] stays peaceful! âœ¨",
      "A sweet alliance! I promise my little soldiers will support you against @[subject]! ðŸ’›",
      "Thank you, dear friend! Together we will keep our lands happy and safe from @[subject]! ðŸ‘"
    ],
    goofball: [
      "OMG yes, let's totally wreck @[subject]'s day, bro! ðŸ˜‚",
      "Alliance locked in! We are about to end @[subject]'s whole career lmao ðŸ’€",
      "No cap, this is a legendary duo. Let's run it down on @[subject] fr fr ðŸ˜­",
      "Bet! @[sender] and me vs @[subject], easiest game of my life haha!",
      "I'm in! Let's go steal @[subject]'s lunch money and split it 50/50 ðŸ’€",
      "Yessir! Time to pull up on @[subject] with the absolute squad! lmao",
      "Double trouble is active! RIP to @[subject], you will not be missed ðŸ˜‚",
      "Let's cook, @[sender]! @[subject] is absolutely not ready for this clown show ðŸ˜­",
      "Lmfao yes! Time to make @[subject] absolutely rage quit this lobby! ðŸ˜‚",
      "Pact confirmed! We are about to run a train on @[subject]'s borders lmfao ðŸ’€",
      "Bet! Let's go take all of @[subject]'s lands and throw a massive victory party! ðŸ˜­",
      "Lmao rip to @[subject]'s defense lines, they are about to get absolute-unit reked! ðŸ˜‚"
    ],
    cynical: [
  ...
  ALLIANCE_DECLINE: {
    ...
    kind: [
      "Oh, I'm so sorry, @[sender]! I don't want to make an enemy out of @[subject] right now. ðŸŒ¸",
      "I think I must decline. I want to try and be friendly with everyone, even @[subject]! ðŸ˜Š",
      "I cannot accept, sorry! Fighting @[subject] together sounds a bit too scary for me. ðŸ’›",
      "Thank you for asking, but I must stay neutral for now. Let's still be friends! âœ¨",
      "I'll have to pass on this one. I hope you and @[subject] can find peace! ðŸ‘",
      "Sorry, @[sender]! My little armies need to stay home and protect our gardens. ðŸ˜Š",
      "I can't accept right now. Sending warm wishes to your campaign anyway! ðŸŒ¸",
      "A decline, sorry! I hope there are no hard feelings between us or @[subject]! âœ¨",
      "Oh, I must say no, sorry! I hope you and @[subject] can find a sweet compromise! ðŸ˜ŠðŸŒ¸",
      "I have to pass, dear friend! Let's hope the battlefield stays peaceful without an alliance! âœ¨",
      "I cannot accept, sorry! Sending happy thoughts to both your frontiers, though! ðŸ’›",
      "A decline, unfortunately! Let's keep things comfortable and honorable on our borders! ðŸ‘"
    ],
    goofball: [
      "Nah, I'd rather watch @[subject] absolute-unit you from the sidelines lmao ðŸ’€",
      "Decline! Fighting @[subject] sounds like effort, and I'm currently eating snacks ðŸ˜‚",
      "No thanks bro, @[subject] has way too many armies. I choose life ðŸ˜­",
      "Decline. My magic 8-ball literally said 'git gud' so I'm staying out of this.",
      "Lmao nope, I am not joining your little anti-@[subject] club today ðŸ’€",
      "I'll pass. I want to see who wins this 1v1 without me interfering haha!",
      "No cap, fighting @[subject] is a terrible idea. Good luck though! ðŸ˜‚",
      "Pass. I'm too busy organizing my emojis to go to war right now ðŸ˜­",
      "Nah bro, @[subject] is currently cooking and I am not looking to get burned lmfao! ðŸ˜‚",
      "Decline! Squeezing @[subject] sounds like a lot of steps and I am super lazy today! ðŸ’€",
      "No thanks bro, I'd rather build a fort in my capital and chill than fight @[subject]! ðŸ˜­",
      "lmao absolutely not! Good luck fighting @[subject]'s giant stacks by yourself! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      "Decline! I don't need your help to conquer @[subject]â€”or you!",
  ...
  CEASEFIRE_ACCEPT: {
    ...
    kind: [
      "Oh, yes please! I gladly accept the ceasefire! Let's be peaceful. ðŸ˜Š",
      "Truce accepted! I'm so happy we can stop fighting each other! âœ¨",
      "Yay, peace! I promise my troops won't step on your flowers, @[sender]! ðŸŒ¸",
      "Agreed! Let's take a nice friendly break and rebuild our lands. ðŸ‘",
      "I accept with a big smile! Mutual safety is the best way forward! ðŸ’›",
      "Ceasefire signed! Let us enjoy some quiet time in our respective empires. ðŸ˜Š",
      "Thank you for proposing this! Let's keep things happy and safe between us. âœ¨",
      "Truce accepted! I hope this is the start of a wonderful, long peace! ðŸŒ¸",
      "Oh, how lovely! Ceasefire locked in happily, let's enjoy the quiet borders! ðŸ˜ŠðŸŒ¸",
      "Yay! Truce is active, my sweet soldiers are so happy to stop fighting! âœ¨",
      "I gladly accept! Let's look out for one another and stay safe, friend! ðŸ’›",
      "Pact confirmed! Sending peaceful thoughts to your beautiful empire! ðŸ‘"
    ],
    goofball: [
      "Sweet! Ceasefire activated. Time to go play some video games ðŸŽ®ðŸ˜‚",
      "Sure thing, @[sender]. I'll pause my invasion plans to do my taxes lmao ðŸ’€",
      "Truce accepted! I promise not to poke your borders with a stick anymore haha!",
      "Bet! Let's take a break and watch the rest of the map burn down ðŸ˜­",
      "No cap, I accept. My virtual soldiers were getting tired anyway ðŸ’€",
      "Agreed! Ceasefire active, let's virtual high-five and chill ðŸ˜‚",
      "Deal! I'll put my armies on standby while they enjoy some digital pizza ðŸ˜­",
      "Truce signed! Let's play nice... at least until my fingers stop cramping lmao",
      "Lmao alright ceasefire active. Time to go take a nap in my capital! ðŸ˜‚",
      "Bet! Ceasefire activated. Go eat some pizza while I organize my emojis! ðŸ’€",
      "No cap truce locked in. Let's chill out and watch the others rage! ðŸ˜­",
      "Lmfao I accept. Let's make sure our little dudes don't throw hands anymore! ðŸ˜‚"
    ],
    cynical: [
  ...
  CEASEFIRE_DECLINE: {
    ...
    kind: [
      "I'm so sorry, but I can't sign a truce right now. Please forgive me! ðŸŒ¸",
      "Oh dear, I must decline. Things are just too busy along our borders. ðŸ’›",
      "I can't accept, sorry! My advisors tell me we must keep moving forward. âœ¨",
      "I'll have to pass on the ceasefire. I hope we can still be friends later! ðŸ˜Š",
      "I'm sorry, @[sender]! I must stay focused on my current expansion plans. ðŸ‘",
      "No ceasefire today, sorry! Sending you a virtual hug instead! ðŸ¤—ðŸŒ¸",
      "I wish I could, but I cannot accept this truce right now. Take care! âœ¨",
      "A decline, unfortunately! Let's hope our battles stay honorable and fair. ðŸ˜Š",
      "Oh dear! I must decline, sorry! Sending sweet thoughts to your garrison! ðŸ˜ŠðŸŒ¸",
      "A decline, unfortunately! I must keep my little soldiers focused on defense! âœ¨",
      "Please forgive me, but I have to say no today! Stay safe out there! ðŸ’›",
      "No ceasefire, sorry! Let us hope our next moves stay happy and kind! ðŸ‘"
    ],
    goofball: [
      "No ceasefire! My magic 8-ball says 'Outlook not so good' for peace lmao ðŸ’€",
      "Decline! I'm on a roll and I don't want to stop the party now ðŸ˜‚",
      "Ceasefire? How about a 'you-cease-to-exist-fire' instead? ðŸ’€ðŸ˜­",
      "Sorry bro, but your territories look way too delicious to ignore lmao",
      "Nah, my armies are already hyping themselves up for a fight. No stop button! ðŸ˜­",
      "Decline. Peace is boring, I came here to throw virtual dice! ðŸ˜‚",
      "Lmao no way, I have a quest to conquer this region and I'm finishing it ðŸ’€",
      "Pass! Let the chaotic dice rolling continue! lmao",
      "Nah bro, ceasefire declined. My little dudes are ready for a rumble! ðŸ˜‚",
      "Decline! Peace is super overrated lmfao. Let's keep rolling! ðŸ’€",
      "No shot bro, ceasefire rejected. I got a scoreboard to climb! ðŸ˜­",
      "Lmfao nope! I'm on a critical mission to paint the map, no stops! ðŸ˜‚"
    ],
    cynical: [
  ...
  DOMINANCE_BRAG: {
    normal: [
      ...
      "Look at the mapâ€”my faction is clearly leading this campaign.",
      ...
      "My Ä‘á»©ng armies are firmly entrenched. It's only a matter of time now.",
    ...
    kind: [
      "Wow, my little empire is growing so big! Thank you all for playing! ðŸ˜Šâœ¨",
      "I'm doing so well! I hope everyone is still having fun out there! ðŸŒ¸ðŸ’›",
      "Look at all my colorful territories! I'm so proud of my sweet armies. ðŸ‘",
      "I seem to have a really good lead! Let's keep our spirits high! ðŸ˜Š",
      "This is so exciting! I'm winning, but I still think you are all wonderful! âœ¨",
      "My borders are looking so safe and beautiful now. Yay! ðŸ’›",
      "I'm in first place! Thank you to my lovely troops for working so hard. ðŸŒ¸",
      "I hope I can bring a peaceful victory to the world. We're doing great! ðŸ˜Š",
      "Yay, my little borders are so happy and colorful today! ðŸ˜ŠðŸŒ¸",
      "I have so many sweet territories now! Thank you all for a great campaign! âœ¨",
      "My little empire is thriving! I send warm wishes to all other frontiers! ðŸ’›",
      "I'm doing great, but I think you are all such strong commanders too! ðŸ‘"
    ],
    goofball: [
      "I'm winning so hard I might rename the map after my cat lmao ðŸ’€ðŸ˜‚",
      "My score is higher than my student loans, I am absolutely built different ðŸ˜­",
      "Look at the map, it's turning my color and it looks gorgeous no cap ðŸ’€",
      "I am currently speedrunning this lobby, please try to keep up haha!",
      "Lmao I'm literally the main character of this game, bow down to my greatness ðŸ‘‘ðŸ˜‚",
      "Victory is so close I can literally taste the victory snacks already ðŸ˜­",
      "Who let me cook this hard? I am absolutely dominating this board! ðŸ’€",
      "Lmao GG WP, you guys can spectate my glorious win now ðŸ˜‚",
      "lmfao I am currently running this lobby on easy mode fr fr! ðŸ˜‚",
      "Victory is literally calling my phone right now, no cap! ðŸ’€",
      "Lmao I'm cooking so hard the database is about to overheat! ðŸ˜­",
      "GG WP guys, my virtual kingdom is officially too cool for this board! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Look at the mapâ€”it's turning my color! You are all completely finished!",
  ...
  BETRAYAL_RESPONSE: {
    ...
    kind: [
      "Oh, I feel so terrible about this! But I had to protect my own borders... ðŸ˜¢ðŸŒ¸",
      "Please don't be mad, @[sender]! It was just the only move I could make! ðŸ’›",
      "I am so, so sorry! I still think you're a wonderful player, I promise! âœ¨",
      "Forgive me! My troops got a bit too excited and marched on your lands. ðŸ˜ŠðŸŒ¸",
      "It hurts my heart to do this, but the game must go on! So sorry! ðŸ˜¢",
      "Please don't hate me! I had to make a move for my little empire. ðŸŒ¸",
      "I'm sorry for breaking our promise, but my advisors insisted on this. ðŸ’›",
      "Sending peaceful thoughts even though my armies had to attack you! ðŸ˜Š",
      "Oh dear! I feel so sad to break our sweet treaty, please forgive me! ðŸ˜¢ðŸŒ¸",
      "I'm so sorry, @[sender]! My little soldiers needed some room to grow! âœ¨",
      "Please forgive our advance! We still think you are an amazing commander! ðŸ’›",
      "It makes me sad, but our little truce had to reach its end. Stay strong! ðŸ‘"
    ],
    goofball: [
      "Lmao surprise! Your shield was down and I simply had to do it ðŸ’€ðŸ˜‚",
      "Betrayal? Nice try! It's just a highly aggressive friendship hug lmao ðŸ˜­",
      "Sorry bro, but your capital was looking way too juicy, no cap ðŸ’€",
      "Lmfao id didn't backstab you, my keyboard just slipped, trust me! ðŸ˜‚",
      "It's not you, @[sender]... it's my absolute need to win this lobby haha!",
      "Oof, that had to hurt! RIP our treaty, you will be remembered ðŸ’€ðŸ˜­",
      "Lmao I had to do it to em! Nothing personal, just gamer moves ðŸ˜‚",
      "Treaty expired! Time to see if your defenses are as good as your chat game ðŸ˜­",
      "lmfao surprise attack! Your borders were looking super delicious bro! ðŸ˜‚",
      "Oof! Teammate privileges have been permanently revoked, lmfao! ðŸ’€",
      "Lmao sorry not sorry, but that capital coordinate was wide open fr fr! ðŸ˜­",
      "Treaty status: deleted! Let's see how those dice treat you now, bro! ðŸ˜‚"
    ],
    cynical: [
  ...
  ACCUSATION_DENIAL: {
    ...
    kind: [
      "Oh dear! I would never break a promise! We didn't have a pact, right? ðŸŒ¸",
      "I think you might have mistaken me for someone else! We had no treaty! ðŸ˜Š",
      "My records say we didn't sign a ceasefire, @[sender]. I'm so sorry! ðŸ’›",
      "I always keep my word! I promise we didn't have an active agreement. âœ¨",
      "Falsely accusing me makes me a bit sad. We never made a treaty! ðŸ˜¢",
      "I love keeping the peace, but we never formalized an alliance, friend! ðŸ‘",
      "Oh, please don't be upset! We really didn't have a pact active between us. ðŸŒ¸",
      "I always play fair! There was no agreement signed on our shared border. ðŸ˜Š",
      "Oh dear! I would never dream of backstabbing! We had no truce, right? ðŸ˜ŠðŸŒ¸",
      "I think there is a little mixup! We didn't sign any ceasefire pact, friend! âœ¨",
      "Please don't be cross! I promise we didn't have any active agreement! ðŸ’›",
      "I always play with honor! No treaty was active on our shared border, sorry! ðŸ‘"
    ],
    goofball: [
      "Bro, we never had a pact lmfao, you are literally seeing ghosts ðŸ’€ðŸ˜‚",
      "Lmao check your spam folder, I definitely never signed any treaty with you ðŸ˜­",
      "Accusing me? No shot! We were never teammates to begin with haha!",
      "Wait, did you think we were besties? I never agreed to that, no cap ðŸ’€",
      "Lmfao you're reaching so hard, we never had an active ceasefire ðŸ˜‚",
      "Lmao did you forget to send the proposal? Because my inbox is empty ðŸ’€",
      "No way! You can't break a promise you never actually made, bro ðŸ˜­",
      "Accusation denied! Try checking your map logs before throwing shade haha!",
      "Lmao reverse card! We were never allies lmfao, check your logs! ðŸ˜‚",
      "Bro you are hallucinating, I definitely never signed any papers with you ðŸ’€",
      "No cap inbox check! Slander denied fr fr, we had no active pact! ðŸ˜­",
      "Lmfao did you forget to click accept? Because my side says zero treaties! ðŸ˜‚"
    ],
    cynical: [
  ...
  BRAG_RESPONSE: {
    ...
    kind: [
      "Oh, wow! You're doing so incredibly well, @[sender]! Congratulations! ðŸ˜Šâœ¨",
      "You are a very strong commander! I hope we can still be friends! ðŸŒ¸",
      "Amazing campaign so far! Let's hope the rest of our game is just as fun and honorable! ðŸ‘",
      "You have such a beautiful empire growing! It is very inspiring! ðŸ˜Š",
      "Great job, @[sender]! Let's all keep trying our best and have a happy game! âœ¨",
      "That is a very impressive score! I'm happy for your success! ðŸ’›",
      "Oh, how exciting! Your little colorful territories look so big now! ðŸ˜ŠðŸŒ¸",
      "You are doing so wonderfully, @[sender]! Sending sweet thoughts to your campaign! âœ¨",
      "Great work! I hope my sweet soldiers can still stand honorable against you! ðŸ’›",
      "Such a strong position! I'm proud of your progress on this board! ðŸ‘",
      "Wow! Let's hope the rest of our battle stays peaceful and lovely! ðŸ˜Š",
      "You are leading so well! Sending warm wishes to your home capital! âœ¨"
    ],
    goofball: [
      "Lmfao ok bro, don't trip on your own cape on the way out ðŸ˜‚",
      "No cap, you are popping off! But definitely watch your back lmao ðŸ’€",
      "Ok main character, let's see how long that crown stays on your head haha!",
      "Bro is flexing on us in 4K, let's see if those dice agree with you lmao ðŸ˜­",
      "Is that a first place badge or are you just happy to see me? haha!",
      "Lmao absolute beast mode activated, someone get this player some water ðŸ’€",
      "Lmfao bro is currently having the time of his life in first place! ðŸ˜‚",
      "No cap, that's a massive flex. Don't slip on your own hype lmfao! ðŸ’€",
      "Okay speedrunner, let's see if those dice can keep up with your chat! haha! ðŸ˜­",
      "Lmao rip to our scores, @[sender] is literally running away with the lobby! ðŸ˜‚",
      "Lmfao okay king, but remember that gravity is highly active on this map! ðŸ’€",
      "Absolute beast mode! Let's see if my little dudes can mount a massive comeback! ðŸ˜­"
    ],
    cynical: [
  ...
  FALSE_BRAG_ROAST: {
    ...
    kind: [
      "Aww, you're trying so hard, @[sender]! But your little empire is still so tiny! Keep trying! ðŸ˜ŠðŸŒ¸",
      "Oh dear, boasting already? But you only have a couple little territories! Stay sweet anyway! âœ¨",
      "I love your enthusiasm, @[sender]! But maybe wait until you actually control a continent? ðŸ’›",
      "That's so cute, @[sender]! Flexing with just a handful of brave soldiers! ðŸ˜Š",
      "Sending warm wishes, but you might want to look at the map, sweet @[sender]! ðŸŒ¸",
      "Oh, bless your heart, @[sender]! Your little colored dots are still so small! âœ¨",
      "What a sweet attempt at flexing! Don't worry, you'll grow bigger soon, @[sender]! ðŸ’›",
      "Oh sweet friend! Big dreams are lovely, but your kingdom is so teeny right now! ðŸ˜Š",
      "You have such a big spirit, @[sender]! If only your territories were as big! ðŸŒ¸âœ¨",
      "Don't get discouraged! Even tiny little kingdoms can grow if you work hard, @[sender]! ðŸ’›",
      "Aww! I'm sending you warm hugs for trying to sound so brave with your 3 territories! ðŸ˜Š",
      "Stay sweet, @[sender]! Maybe one day you'll actually hold enough lands to brag! âœ¨"
    ],
    goofball: [
      "Lmao bro is flexing with a micro-empire and a dream fr fr ðŸ’€ðŸ˜­",
      "No cap @[sender], bro thinks he's the main character with 2 territories lmfao ðŸ˜‚",
      "Flexing with a tiny setup? Someone get this commander a reality check haha! ðŸ’€",
      "Lmfao bro is speedrunning getting roasted in chat fr fr ðŸ˜­",
      "Wait, who let @[sender] cook? The pan is literally empty lmfao! ðŸ˜‚",
      "Bro is flexing on a budget lmfao! Check the scoreboard bro! ðŸ’€",
      "Lmao absolute clown flex! You have like 3 territories total, @[sender] haha! ðŸ˜­",
      "RIP to your ego bro! Did you drop your glasses when you looked at the map? ðŸ’€ðŸ˜‚",
      "No shot bro! You are bragging with a starter pack layout lmfao! ðŸ˜­",
      "Lmao bro wrote a victory speech for a 2-troop outpost, iconic behavior fr fr ðŸ’€",
      "Flexing with zero continents? The audacity is absolute-unit level lmfao! ðŸ˜‚",
      "Bro is main-charactering in a lobby where he's currently side-quest tier ðŸ˜­ðŸ’€"
    ],
    cynical: [
  ...
  FALSE_BULLYING_RESPONSE: {
    ...
    kind: [
      "Oh dear! I haven't even touched your sweet little territories, @[sender]! ðŸ˜ŠðŸŒ¸",
      "Please don't be cross, @[sender]! My cute little troops haven't marched on your home at all! âœ¨",
      "Are you confused, friend? I haven't sent any soldiers to your border, @[sender]! ðŸ’›",
      "Oh my! I would never bully you, @[sender]! In fact, we haven't even fought yet! ðŸ˜Š",
      "Sending warm hugs, but check your map! My armies are way over on the other side! ðŸŒ¸",
      "Oh sweet friend, don't accuse me of being mean! I haven't attacked you once! âœ¨",
      "I promise my little soldiers are innocent, @[sender]! We haven't crossed your line! ðŸ’›",
      "Oh dear! That is so unfair, @[sender]! I've been keeping my distance happily! ðŸ˜Š",
      "Please don't point fingers at my sweet garrison! We haven't fired a single die! ðŸŒ¸",
      "Aww, don't be frightened! I haven't even looked at your continent, sweet neighbor! âœ¨",
      "I play completely fair, @[sender]! Check the history, we haven't fought at all! ðŸ’›",
      "Sending peace thoughts, but your complaint is a little mistake, @[sender]! ðŸ˜Š"
    ],
    goofball: [
      "Bro is crying wolf lmfao! I literally haven't even touched your base, @[sender] ðŸ’€ðŸ˜­",
      "Wait, bullying? Bro is inventing imaginary attacks fr fr lmfao ðŸ˜‚",
      "Lmao bro check the replay! My armies are literally eating pizza in the corner haha! ðŸ’€",
      "No cap @[sender], you are speedrunning false accusations in 4K lmfao ðŸ˜­",
      "Wait, did you dream that I attacked you? I haven't even rolled a die against you bro! ðŸ˜‚",
      "Lmfao absolute clown claim! My soldiers don't even know where your house is! ðŸ’€",
      "Bro is playing victim Simulator 2026 fr fr! Stop gaslighting the lobby lmfao! ðŸ˜­",
      "Lmao reverse card! I haven't attacked you once, get your eyes checked bro haha! ðŸ˜‚",
      "Oof! Imagine complaining about bullying from a player who hasn't even touched you ðŸ’€",
      "Bro is typing fanfiction in the global chat lmfao, zero attacks registered! ðŸ˜­",
      "Lmao bro, my troops are on airplane mode right now, calm down! ðŸ˜‚",
      "No shot bro! You are calling the police on a guy standing 5 continents away lmfao! ðŸ’€"
    ],
    cynical: [
  ...
  FALSE_CAPITAL_DEFIANCE_RESPONSE: {
    ...
    kind: [
      "Oh dear, @[sender]! Your lovely home base is still completely safe! Look! ðŸ˜ŠðŸŒ¸",
      "Are you alright, friend? We aren't playing Capital Rush mode in this match! âœ¨",
      "Don't worry, @[sender]! Nobody has taken your sweet capital city! ðŸ’›",
      "Oh sweet neighbor, your capital is still painted in your beautiful color! ðŸ˜Š",
      "Sending warm thoughts, but check the map! Your home territory is totally fine! ðŸŒ¸",
      "Oh my! No one took your capital, dear friend! You still have it! âœ¨",
      "Don't be scared, @[sender]! Your central kingdom is safe and happy! ðŸ’›",
      "Aww, you don't need to be defiant! Nobody has captured your base! ðŸ˜Š",
      "Check your map, sweet friend! Your capital is standing strong! ðŸŒ¸",
      "Oh! Capital Rush mode isn't enabled today, but your lands are safe anyway! âœ¨",
      "Please don't worry! Your main fortress is still completely yours! ðŸ’›",
      "Sending peace thoughts! Your capital is untouched, @[sender]! ðŸ˜Š"
    ],
    goofball: [
      "Bro, what capital? Your base is literally sitting right there untouched lmfao ðŸ’€ðŸ˜­",
      "Lmao bro is roleplaying losing a capital in Conquest mode fr fr ðŸ˜‚",
      "Wait, did you lose your glasses? Your capital is literally still yours bro haha! ðŸ’€",
      "No cap @[sender], bro is shouting defiance for a territory he still owns ðŸ˜­",
      "Lmfao check the scoreboard! We aren't even playing Capital Rush mode bro! ðŸ˜‚",
      "Bro is speedrunning dramatic speeches for imaginary capital losses lmfao ðŸ’€",
      "Wait, who took your capital? Nobody! It's right there in your color bro! ðŸ˜­",
      "Lmao bro, check the map key! Your capital is 100% fine haha! ðŸ˜‚",
      "Oof! Imagine sending a dramatic capital defiance speech when you still hold it ðŸ’€",
      "Bro is practicing his movie lines in global chat fr fr lmfao ðŸ˜­",
      "Lmao false alarm! Go drink some water, your base is totally safe bro! ðŸ˜‚",
      "No shot bro! You still have your capital, stop dramatic posting lmfao! ðŸ’€"
    ],
    cynical: [
  ...
  FALSE_FINAL_DUEL_RESPONSE: {
    ...
    kind: [
      "Oh dear! Don't forget about our other sweet friends on the map, @[sender]! ðŸ˜ŠðŸŒ¸",
      "It's not a final duel yet, @[sender]! We still have other lovely commanders playing! âœ¨",
      "Aww, don't leave the rest of the lobby out! There are still more than 2 of us! ðŸ’›",
      "Oh sweet friend! Look around! We still have a full board of wonderful players! ðŸ˜Š",
      "Sending warm wishes, but remember we aren't in a 1v1 duel yet! ðŸŒ¸",
      "Oh my! Don't celebrate a duel early, @[sender]! Other troops are still here! âœ¨",
      "We still have a happy multi-player battle going on, @[sender]! ðŸ’›",
      "Aww, sweet neighbor! It's not just the two of us yet! ðŸ˜Š",
      "Check the map, dear friend! Other commanders are still standing strong! ðŸŒ¸",
      "Not so fast! We still have other lovely factions playing with us! âœ¨",
      "Don't forget our other friends on the board! Stay sweet and keep fighting! ðŸ’›",
      "Sending love, but let's pay attention to all our fellow players on the map! ðŸ˜Š"
    ],
    goofball: [
      "Final duel? Bro, there are literally other people in the lobby lmfao ðŸ’€ðŸ˜­",
      "Lmao bro forgot there are other players on the map fr fr ðŸ˜‚",
      "Wait, 1v1? Bro is hallucinating that everyone else got eliminated haha! ðŸ’€",
      "No cap @[sender], bro is ignoring half the lobby like a absolute boss ðŸ˜­",
      "Lmfao check the player list! We are not in a final duel bro! ðŸ˜‚",
      "Bro is speedrunning declaring 1v1s while 4 other guys are standing there ðŸ’€",
      "Wait, who told you this was a duel? There's literally a full lobby left bro! ðŸ˜­",
      "Lmao bro, look at the top left! Other colors exist on this map haha! ðŸ˜‚",
      "Oof! Imagine calling a 1v1 duel when 3 other players are building stacks ðŸ’€",
      "Bro is playing solo mode in a multi-player lobby fr fr lmfao ðŸ˜­",
      "Lmao false duel! Go check on the guy building 50 troops next to you bro! ðŸ˜‚",
      "No shot bro! You cannot just delete the other players from your brain lmfao! ðŸ’€"
    ],
    cynical: [
  ...
  ALLIANCE_FORMED_RESPONSE: {
    ...
    kind: [
      "Oh, how lovely! I hope you two are very happy allies! ðŸ˜Šâœ¨",
      "That's so nice! Try to be good to each other and keep the peace! ðŸŒ¸",
      "A wonderful partnership! Stand strong together! ðŸ‘",
      "I'm so glad you found a friend on this busy battlefield! Stay safe! ðŸ’›",
      "Sending warm wishes to your new alliance! Let's keep things honorable! ðŸ˜Š",
      "That is a sweet treaty. I hope it brings peace to your shared borders! âœ¨",
      "Oh, how wonderful! Have a happy and safe partnership, friends! ðŸ˜ŠðŸŒ¸",
      "A lovely alignment! Let us hope this brings more peace to our world! âœ¨",
      "Such a great team! I promise my soldiers will stay friendly to you both! ðŸ’›",
      "sending happy thoughts to your joint campaign! Stand honorable! ðŸ‘",
      "So sweet! Let's make sure our shared borders stay quiet and comfortable! ðŸ˜Š",
      "Congratulations on your treaty! I hope it brings you both lots of success! âœ¨"
    ],
    goofball: [
      "Oof, the absolute dynamic duo is active lmfao ðŸ’€",
      "Are you guys holding hands now? Very cute haha! ðŸ˜‚",
      "Squad goals active! Let's see if you guys actually share the loot ðŸ˜­",
      ...
      "No cap, you guys are about to wreak absolute havoc on this map ðŸ’€",
      "Lmao alright squad goals locked in. RIP to the rest of the board! ðŸ˜‚",
      "Double trouble activated! Are you guys split-screening this lobby lmfao? ðŸ’€",
      "Oof! The dynamic duo has arrived! Time to buy some virtual popcorn! ðŸ˜­",
      "Lmfao are you guys besties now? Very cute, no cap! ðŸ˜‚",
      "Squad up! Let's see if you guys can actually share the treasure lmfao! ðŸ’€",
      "Wait, do we need to wear matching uniforms now? This is legendary haha! ðŸ˜­"
    ],
    cynical: [
  ...
  ALLIANCE_TARGET_RESPONSE: {
    ...
    kind: [
      "Oh dear, a double-team against me? I hope we can still find a peaceful solution! ðŸŒ¸ðŸ˜¢",
      "Teaming up against my little empire? I promise I'm not a threat, please don't be mean! ðŸ’›",
      "This makes my soldiers very nervous... Can we please talk about this first? ðŸ˜¢",
      "I wish you wouldn't gang up on me! I always try to be a friendly neighbor! ðŸŒ¸",
      "Oh my, two against one? Let's hope we can still keep things happy and respectful! ðŸ˜Š",
      "I will do my best to protect my sweet home, even if it is a bit scary right now. âœ¨",
      "Oh dear! A dual campaign against us? Please be gentle, friends! ðŸ˜ŠðŸŒ¸",
      "My poor little borders are feeling so crowded! Sending peaceful wishes anyway! âœ¨",
      "Teaming up against my garden? I promise my troops are totally peaceful! ðŸ’›",
      "Oh my, two commanders targeting us? Let us hope we can still find a friendly treaty! ðŸ‘",
      "I will try my best to guard our home, but please let's keep the game happy! ðŸ˜Š",
      "A double-team? Sending warm thoughts in hopes of a quiet boundary de-escalation! âœ¨"
    ],
    goofball: [
      "Lmfao ok a 2v1? Very brave of you guys, I'm absolutely honored lmfao ðŸ’€",
      "Wow, it takes both of you to handle me? I am officially a legendary boss fight haha! ðŸ˜‚",
      "A literal raid boss setup! Let's see if your squad has enough DPS to take me down ðŸ˜­",
      ...
      "Two guys, one map, and they are both staring at my base. RIP to me haha! ðŸ’€",
      "Lmfao alright, 2v1 activated! Let's see if you guys actually have any coordination! ðŸ˜‚",
      "Double trouble on my border! I'm calling the virtual police lmfao! ðŸ’€",
      "Oof! It takes the whole lobby to handle me? I am absolutely built different haha! ðŸ˜­",
      "Lmao alright raid party, let's see if you can break my castle walls! ðŸ˜‚",
      "No cap, this is a massive double-team lmfao. RIP to my spare time! ðŸ’€",
      "Wait, are you guys sharing a headset? This is legendary bullying lmfao! ðŸ˜­"
    ],
    cynical: [
  ...
  PROTEST_ACCEPT: {
    ...
    kind: [
      "Oh, I'm so sorry! I didn't mean to make you nervous! I'll move them back right away! ðŸ˜ŠðŸŒ¸",
      "I promise I wasn't planning anything mean! Moving my sweet troops back now! âœ¨",
      "I want us to stay great neighbors! Vacating [border_territory] immediately, friend! ðŸ‘",
      "Sending peaceful thoughts! Shifting my soldiers away from [border_territory] to keep us safe! ðŸ’›",
      "My apologies! I will make sure my troops respect your space and move back. ðŸ˜Š",
      "I never want to make you feel crowded! Repositioning my armies right now! âœ¨",
      "Oh dear! I am so sorry for making you feel uncomfortable! Moving them back now! ðŸ˜ŠðŸŒ¸",
      "I promise my little soldiers are peaceful! Shifting them out of [border_territory] immediately! âœ¨",
      "I want us to stay best neighbors! Vacating [border_territory] on our next turn, friend! ðŸ’›",
      "Sending warm wishes! Repositioning my defensive guard away from [border_territory] to keep us happy! ðŸ‘",
      "All done! Shifting my armies away so we can both have comfortable borders! ðŸ˜Š",
      "I apologize! Relocating forces right now to make sure we keep the peace! âœ¨"
    ],
    goofball: [
      "Lmao my bad bro, didn't mean to scare you. Shifting my little dudes back now haha!",
      "Haha all good, I'll back them off. Didn't realize I was crowding you! ðŸ˜‚",
      "No cap, we'll pack up the campsite in [border_territory] and clear out lmfao! ðŸ’€",
      "Sure thing! Repositioning my squad so we don't start any accidental drama! ðŸ˜­",
      "Lmao my soldiers were just looking for the nearest pizza place, backing up! ðŸ˜‚",
      "All good! Moving the boys back so we can all keep chilling peacefully. ðŸ’€",
      "Lmao oops, didn't mean to crowd your lawn bro! Shifting them back now! ðŸ˜‚",
      "All good! Repositioning the squad out of [border_territory] to prevent any drama lmfao! ðŸ’€",
      "No cap, backing the boys up. Sparing you the heart attack bro! ðŸ˜­",
      "Lmfao my bad, relocation activated. Go eat some pizza and relax! ðŸ˜‚",
      "Truce vibes active! Shifting our little dudes out of [border_territory] lmfao! ðŸ’€",
  ...
  PROTEST_DECLINE: {
    ...
    kind: [
      "I'm so sorry, but I really need to keep my friendly troops there to protect my home. ðŸ’›",
      "I wish I could, but my advisors tell me [border_territory] is too dangerous to leave empty. ðŸŒ¸",
      "I have to say no, sorry! Sending sweet thoughts, but my garrison must protect their homes. ðŸ˜Š",
      "I can't clear [border_territory] right now. I promise my intentions are completely peaceful, though! âœ¨",
      "I am sorry to decline, but my little soldiers need to stay there to guard our garden. ðŸŒ¸",
      "Please forgive me, but I must keep a defensive guard at [border_territory] for safety! ðŸ’›",
      "Oh, please don't be cross! I really need to keep our guard at [border_territory] safe! ðŸ˜¢ðŸŒ¸",
      "I am so sorry to decline! My poor troops need to stay there to guard our home! âœ¨",
      "Please forgive me, but [border_territory] is just too risky to leave empty today! ðŸ’›",
      "I wish I could, but I must keep our defense at [border_territory] for peace of mind! ðŸ‘",
      "A decline, sorry! Sending warm thoughts, but our little outpost must remain! ðŸ˜Š",
      "Please forgive our decline! I promise our intentions are completely friendly! âœ¨"
    ],
    goofball: [
      "Nah, my troops really love the scenery in [border_territory]. We're staying put! ðŸ’€",
      "No can do bro, the lobby is too wild to leave my borders empty lmfao!",
      "Decline! The boys are already set up in [border_territory] and they refuse to pack up! ðŸ˜‚",
      "Lmao nope, we built a fort in [border_territory] and we're not vacating anytime soon! ðŸ˜­",
      "Declined! My little virtual dudes are currently having a campfire in [border_territory] haha!",
      "No shot bro, [border_territory] is our prime real estate. We are staying! lmfao ðŸ’€",
      "Nah bro, no can do. The boys built a massive sandbox in [border_territory]! ðŸ˜‚",
      "Decline! Sparing [border_territory] sounds super boring, let's keep the fort lmfao! ðŸ’€",
      "No shot bro, my troops are currently holding a gaming tournament in [border_territory]! ðŸ˜­",
      "Lmfao decline! The fort in [border_territory] has way too cool of a view to leave! ðŸ˜‚",
      "No cap, we are staying put. Sparing you the empty space bro! lmfao ðŸ’€",
  ...
  MERCY_ACCEPT: {
    ...
    kind: [
      "Oh, please don't cry! I will gladly grant you mercy! Let's be at peace! ðŸ˜ŠðŸŒ¸",
      "I can't bring myself to eliminate you! I will turn my armies away, stay safe! âœ¨",
      "Yay, peace! I promise my troops won't step on your final borders! ðŸ‘",
      "I accept with a big smile! Mutual safety is always the best way forward! ðŸ’›",
      "Of course, friend! I want everyone to have a good game. Truce accepted! ðŸ˜ŠðŸŒ¸",
      "I gladly spare your lands! Let us keep our borders peaceful and friendly! âœ¨",
      "Oh, please don't be sad! I gladly grant you mercy! Stay safe! ðŸ˜ŠðŸŒ¸",
      "I promise my little soldiers won't touch your final frontiers! âœ¨",
      "Yay, peace! Let us declaring ceasefire and look out for one another! ðŸ’›",
      "I accept with a warm smile! Sending happy thoughts to your campaign! ðŸ‘",
      "Of course, dear friend! Your remaining outposts are completely safe with us! ðŸ˜Š",
      "Mercy gladly granted! Let us enjoy some quiet time in our empires! âœ¨"
    ],
    goofball: [
      "All good bro, I'll give you a pass. Go rebuild your base haha! ðŸ˜‚",
      "Sure thing, I'll pause my campaign against you. Go grab some snacks! ðŸ˜­",
      "Bet! Let's take a break and watch the rest of the map burn down, lmfao! ðŸ’€",
      "Truce signed! Play nice, at least until my fingers stop cramping haha!",
      "Lmao okay, ceasefire activated. Go buy a lottery ticket with this luck! ðŸ˜‚",
      "No cap, I'll cede the spotlight for a bit. Stay safe out there bro! ðŸ’€",
      "All good, pass granted! Go eat some real-life snacks and rebuild! ðŸ˜‚",
      "lmfao ceasefire active. Go buy a lottery ticket because you are super lucky! ðŸ’€",
      "No cap, I'll pause my advance. Sparing you so we can chill haha! ðŸ˜­",
      "Truce locked in! Let's watch the others fight lmfao! ðŸ˜‚",
      "Lmao alright, ceasefire activated. Keep your little dudes safe bro! ðŸ’€",
      "GG to your capital, but I'll spare the rest. Go grab some digital pizza! haha! ðŸ˜­"
    ],
    cynical: [
  ...
  MERCY_DECLINE: {
    ...
    kind: [
      "I am so incredibly sorry! But my advisors insist I must take these sectors. ðŸ˜¢ðŸŒ¸",
      "Please forgive me! I must secure these lands, but I still think you're wonderful! ðŸ’›",
      "I wish I could help, but the game is too far along! Sending big warm thoughts! âœ¨",
      "A decline, unfortunately! Let's hope our final battle is honorable and fair. ðŸ˜Š",
      "It hurts my heart, but I must say no. I have to protect my own borders now. ðŸ˜¢",
      "Oh, I am so sorry! I cannot grant a truce. Let us play out our final rounds with honor! âœ¨",
      "Oh dear! I am so incredibly sorry! Sparing your outposts is too difficult now! ðŸ˜¢ðŸŒ¸",
      "Please forgive me! I must defend my home first, but sending warm wishes! âœ¨",
      "My heart breaks, but ceasefire is declined! Sparing you would make things too volatile! ðŸ’›",
      "Oh, I wish I could! Sparing your garrison is not possible under my advisors' plans! ðŸ‘",
      "A decline, unfortunately! Let us hope our final battle is quiet and honorable! ðŸ˜Š",
      "Please forgive our decline! I still think you are such a wonderful player! âœ¨"
    ],
    goofball: [
      "Sorry bro, but the leaderboard demands your sacrifice. RIP in advance! ðŸ’€",
      "No can do, my armies are on autopilot and they only know how to attack lmfao!",
      "Decline! I'm on a roll and I don't want to pause the party now haha! ðŸ˜‚",
      "Lmao nope! The victory screen is calling my name, no stops! ðŸ˜­",
      "No cap, my dice are literally itching to roll. Truce declined bro! ðŸ’€",
      "Lmfao I gotta get that final knockout. Better luck next lobby! haha!",
      "Oof, decline! Sparing you would block my speedrun lmfao! ðŸ˜‚",
      "No cap, ceasefire rejected bro. Sparing you is not in my plans today! ðŸ’€",
      "Lmao sorry but my little dudes are on autopilot. RIP to your outposts! ðŸ˜­",
      "Decline! Sparing your capital would ruin the victory party lmfao! ðŸ˜‚",
      "No shot bro, truce denied. Better luck in the next lobby! haha! ðŸ’€",
      "Lmfao nope! Sparing you is simply impossible right now, RIP in advance! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "No truces! I will trample your final outposts and erase your standard! ðŸ˜¡",
  ...
  MERCY_ANNOYED: {
    ...
    kind: [
      "Oh, please don't keep asking! It makes me feel too sad, but I must say no! ðŸ˜¢ðŸŒ¸",
      "I already spared you once! Please don't take advantage of my kindness. ðŸ’›",
      "Please don't spam me! I want to be nice, but we cannot sign another truce! âœ¨",
      "It hurts my heart, but I must ask you to stop begging! I cannot grant mercy again. ðŸ˜Š",
      "Oh dear! I must ask you to stop sending these. I have to say no, sorry! ðŸ˜¢",
      "I wish we could be peaceful, but please stop begging me! It's too much! ðŸŒ¸",
      "Oh, please don't keep asking! It makes my little soldiers feel too sad! ðŸ˜¢ðŸŒ¸",
      "I already granted mercy once, please don't squeeze our friendly truce! âœ¨",
      "Please stop spamming, friend! I want us to stay comfortable but we cannot truce! ðŸ’›",
      "It hurts my heart, but please stop sending duplicate peace proposals! ðŸ‘",
      "I must ask you to stop begging, sorry! Sparing you is not possible today! ðŸ˜Š",
      "I wish we could find a friendly treaty, but please stop begging, friend! âœ¨"
    ],
    goofball: [
      "Bro, you are literally spamming the mercy button lmfao. Get ready! ðŸ’€",
      "No shot! One plea was enough, now you're just begging haha! ðŸ˜‚",
      "Lmao you are spamming my inbox with peace flags. Decline, no cap! ðŸ˜­",
      "Haha stop begging bro! You already got your pass, now it's game over! ðŸ’€",
      "My notifications are literally blowing up, please stop lmfao! ðŸ˜‚",
      "Are you macroing this chat or what? Decline! Time to fight bro! ðŸ’€",
      "Bro, you are literally spamming the peace flag lmfao! Settle down! ðŸ˜‚",
      "No shot! Sparing you once was enough, now you're just button-mashing! ðŸ’€",
      "Lmao duplicate request! Sparing you is officially offline, no cap! ðŸ˜­",
      "Haha stop begging bro! Go play some other game, we are rolling sixes! ðŸ˜‚",
      "Lmfao are you spamming my inbox? Sparing your base is completed lmfao! ðŸ’€",
      "RIP to my chat log bro, please stop begging! Sparing you is closed! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Silence! I am sick of your continuous begging, weakling! ðŸ˜¡",
  ...
  MOVE_TROOPS_ACCEPT: {
    ...
    kind: [
      "Oh, of course! I didn't mean to crowd you at [border_territory], I'll move them back! ðŸ˜Š",
      "No problem at all, @[sender]! Shifting my sweet troops away from [border_territory] now! âœ¨",
      "I want you to feel totally safe! I will vacate [border_territory] on my next turn! ðŸ‘",
      "All done! Repositioning my friendly guard away from [border_territory] to keep us peaceful! ðŸŒ¸",
      "My apologies! I will shift them away so we can be comfortable neighbors! ðŸ˜Š",
      "I promise my armies are moving back! No crowded borders here! âœ¨",
      "Oh, of course! I didn't mean to make you nervous! Moving them back now! ðŸ˜ŠðŸŒ¸",
      "No problem, friend! Shifting my sweet little armies away from [border_territory]! âœ¨",
      "I want us to stay best neighbors! Vacating [border_territory] on our next turn! ðŸ’›",
      "All done! Repositioning my friendly troops to keep things peaceful! ðŸ‘",
      "I apologize! Shifting my defensive guard away so you feel totally safe! ðŸ˜Š",
      "No worries! Moving my soldiers back immediately so we can have happy borders! âœ¨"
    ],
    goofball: [
      "My bad, bro! Shifting my little dudes back from [border_territory] now lmfao! ðŸ˜‚",
      "Sure thing, packing up the camper vans and vacating [border_territory] lol!",
      "No cap, I'll clear out of [border_territory]. Didn't realize I was hogging the space! ðŸ’€",
      "Peace out! Moving my armies away from [border_territory] so we can chill! ðŸ˜­",
      "Haha all good, backing my squad out of [border_territory] right now! ðŸ˜‚",
      "Lmao backing up, wouldn't want the boys to make you nervous! ðŸ’€",
      "Lmao oops, didn't mean to crowd your lawn bro! Shifting them back now! ðŸ˜‚",
      "All good! Repositioning the squad out of [border_territory] lmfao! ðŸ’€",
      "No cap, backing the boys up. Sparing you the panic bro! haha! ðŸ˜­",
      "Lmfao my bad, relocation activated. Pizza party is over in [border_territory]! ðŸ˜‚",
      "Truce vibes active! Shifting our little dudes out of the area lmfao! ðŸ’€",
  ...
  MOVE_TROOPS_DECLINE: {
    ...
    kind: [
      "I'm so sorry, @[sender], but my advisors say we really must keep our troops in [border_territory]. ðŸŒ¸",
      "Oh dear, I must decline. I need those sweet soldiers there to keep my borders safe! ðŸ˜¢",
      "I wish I could help, but [border_territory] is just too dangerous to leave empty right now! ðŸ’›",
      "I have to say no, sorry! Sending warm thoughts, but my garrison must protect their homes. ðŸ˜Š",
      "Please forgive me, but my little soldiers need to stay there to guard our borders. ðŸŒ¸",
      "I'm so sorry! I must keep my defenses at [border_territory] for my own peace of mind. ðŸ’›",
      "Oh, please don't be cross! I really need to keep our guard at [border_territory] safe! ðŸ˜¢ðŸŒ¸",
      "I am so sorry to decline! My poor troops need to stay there to guard our home! âœ¨",
      "Please forgive me, but [border_territory] is just too risky to leave empty today! ðŸ’›",
      "I wish I could, but I must keep our defense at [border_territory] for peace of mind! ðŸ‘",
    ...
    goofball: [
      "Nah, my troops really love the local cuisine in [border_territory], we aren't leaving! ðŸ’€",
      "Decline! The boys are already set up in [border_territory] and they refuse to pack up lmfao!",
      "No can do, bro! [border_territory] is our favorite spot, too comfy to vacate haha! ðŸ˜‚",
      "Lmao nope! We built a fort in [border_territory] and the lease doesn't end this turn! ðŸ˜­",
      "Declined! My troops are currently holding a virtual gaming tournament in [border_territory]! ðŸ˜‚",
      "No shot bro, [border_territory] is where the squad is hanging out. We stay! ðŸ’€",
      "Nah bro, no can do. The boys built a massive sandbox in [border_territory]! ðŸ˜‚",
      "Decline! Sparing [border_territory] sounds super boring, let's keep the fort lmfao! ðŸ’€",
      "No shot bro, my troops are currently holding a gaming tournament in [border_territory]! ðŸ˜­",
      "Lmfao decline! The fort in [border_territory] has way too cool of a view to leave! ðŸ˜‚",
  ...
  CLAIM_TERRITORY_ACCEPT: {
    ...
    kind: [
      "Oh, of course! [requested_territory] is all yours! I hope it brings you success! ðŸ˜Š",
      "I gladly accept! Let's stay clear of [requested_territory] and keep things peaceful! âœ¨",
      "It's a promise! I'll leave [requested_territory] to your beautiful empire! ðŸ‘",
      "That sounds lovely! Stay clear of [ai_territory] and we will have a wonderful, quiet border! ðŸŒ¸",
      "Of course, friend! I will make sure my troops stay away from [requested_territory]! ðŸ˜Š",
      "I gladly agree! Let us leave [requested_territory] to your kind empire! âœ¨",
      "Oh, how lovely! [requested_territory] is completely yours, friend! ðŸ˜ŠðŸŒ¸",
      "I gladly accept! My little soldiers promise to bypass [requested_territory]! âœ¨",
      "A sweet agreement! Let us stay clear of each other's home sectors! ðŸ’›",
      "Pact confirmed! Sending warm wishes to your new holdings in [requested_territory]! ðŸ‘",
      "Of course! I hope you have a beautiful and happy home in [requested_territory]! ðŸ˜Š",
      "I promise! Let us make [requested_territory] a quiet zone of peace! âœ¨"
    ],
    goofball: [
      "All yours, bro! [requested_territory] has terrible weather anyway lmfao! ðŸ˜‚",
      "Bet! I'll stay clear of [requested_territory]. Enjoy the free real estate haha!",
      "Deal! You take [requested_territory] and I'll keep [ai_territory], high-five! ðŸ’€",
      "Lmao ok, claiming expired. I will steer clear of [requested_territory] fr fr! ðŸ˜­",
      "Haha okay! No touchy [requested_territory], I got it! Have fun building there! ðŸ˜‚",
      "Lmfao all yours! I'll go buy real estate somewhere else on the map! ðŸ’€",
      "Lmao all yours bro! [requested_territory] has terrible Wi-Fi anyway! ðŸ˜‚",
      "Bet! Sparing [requested_territory] is locked in, no cap! ðŸ’€",
      "No shot! I'll let you have [requested_territory] so we don't start any drama haha! ðŸ˜­",
      "Deal confirmed! Go build a massive castle in [requested_territory] lmfao! ðŸ˜‚",
      "Lmao alright, claiming accepted. Sparing you the sector bro! ðŸ’€",
      "lmfao all yours! I'll go park my armies in some other cool coordinate! haha! ðŸ˜­"
    ],
    cynical: [
  ...
  CLAIM_TERRITORY_DECLINE: {
    ...
    kind: [
      "I'm so incredibly sorry! But my advisors insist we must secure [requested_territory]. ðŸ˜¢",
      "Oh dear, I must decline. [requested_territory] is just too important for my home safety. ðŸŒ¸",
      "Please don't ask for [requested_territory]! My soldiers are so happy there! ðŸ’›",
      "No claim today, sorry! I hope you can find other beautiful territories to conquer! ðŸ˜Š",
      "I am so sorry to say no, but my poor soldiers really need [requested_territory]! ðŸ˜¢",
      "Please forgive me, but I must decline. Sending warm wishes to your other borders! âœ¨",
      "Oh, please don't be cross! I really need to protect [requested_territory]! ðŸ˜¢ðŸŒ¸",
      "I am so sorry to decline! My poor troops worked so hard for [requested_territory]! âœ¨",
      "Please forgive our decline! Sparing [requested_territory] is too risky for our home! ðŸ’›",
      "I wish I could, but my advisors say we need [requested_territory] for safety! ðŸ‘",
      "A decline, sorry! Sending happy thoughts to your other fronts, friend! ðŸ˜Š",
      "Please forgive me! I must protect my base before I can cede [requested_territory]! âœ¨"
    ],
    goofball: [
      "No shot, bro! I've already bought real estate in [requested_territory], can't back out lmfao! ðŸ’€",
      "Decline! [requested_territory] looks way too juicy to give up haha!",
      "Lmao nope! My dice are already rolling towards [requested_territory], no stop button! ðŸ˜‚",
      "Pass! [requested_territory] belongs to the squad now, finders keepers! ðŸ˜­",
      "Haha decline! I already promised my soldiers we'd vacation in [requested_territory]! ðŸ˜‚",
      "Lmfao no way, [requested_territory] is already painted in my mind. No deal bro! ðŸ’€",
      "No shot bro, claim denied! [requested_territory] is already my primary coordinate! ðŸ˜‚",
      "Decline! Sparing [requested_territory] is strictly impossible lmfao! ðŸ’€",
      "Lmao sorry but the squad is already heading to [requested_territory] haha! ðŸ˜­",
      "No way! [requested_territory] has way too cool of a view to give up lmfao! ðŸ˜‚",
      "lmao decline! [requested_territory] is mine fr fr, finders keepers bro! ðŸ’€",
      "Lmfao nope! My dice are already targeted on [requested_territory], no stop button! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Never! Sparing [requested_territory] is complete nonsense. Suffer my vanguard! ðŸ˜¡",
  ...
  DESPERATION: {
    ...
    kind: [
      "Oh dear, my poor little armies are almost gone... Is there anyone who can show me kindness? ðŸŒ¸ðŸ˜¢",
      "I don't want to be eliminated! Please, is there any commander willing to protect me? ðŸ’›",
      "Sending out a plea for peace! My home is crumbling, let's please stop fighting! âœ¨",
      "Oh please, can we declare a truce? I promise I'm not a threat to anyone! ðŸ˜Š",
      "Oh my, I am in a very scary spot... Please show some mercy to my sweet soldiers! ðŸ˜¢",
      "My little empire is fading away... Sending warm thoughts in hopes of a ceasefire! âœ¨",
      "Oh dear! My poor soldiers are almost gone! Please show some sweet mercy! ðŸ˜¢ðŸŒ¸",
      "I don't want my empire to fade! Is there anyone willing to be a kind protector? ðŸ’›",
      "My home is in complete ruins! Let us please stop fighting and be friendly! ðŸ˜Š",
      "Oh please, I beg of you! A ceasefire would make us so happy and safe! ðŸ‘",
      "sending happy wishes even though my garrison is crumbling! Sparing requested! ðŸ˜Š",
      "My sweet little kingdom is disappearing... Sending love in hopes of a truce! âœ¨"
    ],
    goofball: [
      "Bro, I am literally down to my last stand lmfao. Anyone want to buy a slightly used capital? Cheap! ðŸ˜‚",
      "Oof, my base is in complete shambles. Currently taking applications for a protective ally ðŸ’€ðŸ˜­",
      "Lmao RIP to my armies, they got absolutely reked. Please show mercy haha!",
      "My score is in the gutter, no cap. Can I get a temporary pass to go grab some snacks? ðŸ˜­",
      "Lmfao my empire has officially left the chat. Anyone want to carry me? ðŸ˜‚",
      "RIP to my glorious reign, we are down to the absolute bare minimum lmfao! ðŸ’€",
      "Bro, my capital has left the lobby lmfao! Sparing highly requested! ðŸ˜‚",
      "Oof! My squad has been absolute-unit wiped. Need a pro carry bro! ðŸ’€",
      "No cap, my board state is tragic. Sparing me would be legendary haha! ðŸ˜­",
      "Lmfao alright, taking applications for a protective alliance. Apply now! ðŸ˜‚",
      "My score is in the trash lmfao! Sparing me would be super cool of you! ðŸ’€",
      "lmao RIP to my legions, they got completely wrecked. Sparing active bro! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "No surrender! We will leave your advance completely broken before we fall! ðŸ˜¡",
  ...
  BETRAYAL_ATTACK: {
    ...
    kind: [
      "Oh, I feel so terrible about this! But my advisors insisted we must take this sector... ðŸ˜¢ðŸŒ¸",
      "Forgive me! It hurts my heart to break our promise, but my little empire needs these lands. ðŸ’›",
      "I am so, so sorry! Please don't hate me, the campaign made me do it! âœ¨",
      "Sending peaceful thoughts even though my troops had to march! I still think you're great! ðŸ˜Š",
      "Please forgive my soldiers! They got too excited and marched across the boundary! ðŸ˜¢",
      "I am so sorry for breaking our sweet promise, but I had to make a move for safety! ðŸŒ¸",
      "Oh, I feel so incredibly bad! Please don't be cross with my little soldiers! ðŸ˜¢ðŸŒ¸",
      "Forgive me, dear friend! My advisors insisted we needed to take [border_territory]! âœ¨",
      "I am so sorry! Sparing your capital was just no longer possible, I promise! ðŸ’›",
      "Please don't hate us! Sending happy thoughts even though we must fight! ðŸ‘",
      "My poor soldiers got too excited and crossed the line! So sorry! ðŸ˜Š",
      "I feel so sad to break our sweet treaty, but our empire had to expand! âœ¨"
    ],
    goofball: [
      "Lmao surprise! Your shield was down and I simply had to do it ðŸ’€ðŸ˜‚",
      "Oof, our treaty just expired bro! Time to see if your defenses are actually good haha!",
      "Surprise! Teammate privileges have been permanently revoked, lmfao! ðŸ˜­",
      "Sorry bro, but your capital was looking way too juicy to ignore, no cap! ðŸ’€",
      "Lmfao I couldn't resist, the temptation was way too high! Sorry not sorry! ðŸ˜‚",
      "Treaty has left the lobby! Time to roll some massive dice haha! ðŸ’€",
      "Lmao surprise attack! Your borders were looking super delicious, no cap! ðŸ˜‚",
      "Oof! Teammate tethers have been permanently deleted, lmfao! ðŸ’€",
      "Lmao sorry but that capital coordinate was looking way too juicy haha! ðŸ˜­",
      "Surprise attack active! Go eat some pizza and prepare for the storm lmfao! ðŸ˜‚",
      "Lmao rip to our truce bro, relocation sequence failed lmfao! ðŸ’€",
      "Treaty deleted! Let's see if those dice are as strong as your chat! haha! ðŸ˜­"
    ],
    cynical: [
      "We both knew this truce was temporary. I just moved first.",
  ...
  MOVE_TROOPS_FAIL_NO_TROOPS: {
    ...
    kind: [
      "Oh dear, I don't think I have any little soldiers in [border_territory], @[sender]! ðŸ˜Š",
      "I checked, but my rooms in [border_territory] are empty! Let's double check our map. ðŸŒ¸",
      "I promise my troops aren't crowding [border_territory]! I don't own any garrisons there! âœ¨",
      "I'd love to help, but I have no armies to withdraw from [border_territory]! Sorry! ðŸ’›",
      "Oh, I think there is a little mixup! My soldiers are not in [border_territory]! ðŸ˜Š",
      "I checked my records and we don't have anyone stationed there! Sending warm thoughts! ðŸŒ¸",
      "Oh, I think there is a sweet little mixup! [border_territory] is empty! ðŸ˜ŠðŸŒ¸",
      "I checked my maps, but my rooms in [border_territory] have no soldiers inside! âœ¨",
      "I promise my troops aren't crowding your space, friend! Sparing [border_territory] is easy! ðŸ’›",
      "I'd love to move them, but I have no little dudes at that coordinate! ðŸ‘",
      "Our records show zero garrisons in [border_territory]! Sending happy thoughts! ðŸ˜Š",
      "No little soldiers are there, sorry! I hope you can find your way around! âœ¨"
    ],
    goofball: [
      "Bro, you are literally hallucinating. I have zero dudes in [border_territory] lmfao! ðŸ’€",
      "Lmao check your glasses, my armies are nowhere near [border_territory] haha!",
      "No shot! I don't have any troops in [border_territory]. Are we fighting ghosts today? ðŸ˜‚",
      "Lmfao my bad if I scared you, but my garrison at [border_territory] is literally imaginary! ðŸ˜­",
      "Wait, am I laggy or do I actually have zero dudes in [border_territory]? lmfao",
      "Lmao check the map again bro, we are completely empty in that sector! ðŸ’€",
      "Bro, you are seeing virtual ghosts lmfao! [border_territory] is completely empty! ðŸ˜‚",
      "Lmao check your connection, my troops are miles away from that coordinate! ðŸ’€",
      "No shot bro, I don't hold any lands at [border_territory] haha! ðŸ˜­",
      "Wait, are those my units or is that just some colored dust on your screen? lmfao ðŸ˜‚",
      "lmao decline! I can't move what isn't there bro, check your logs! ðŸ’€",
      "RIP to your scouts bro, they are reporting imaginary garrisons lmfao! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Silence! I do not hold [border_territory], but keep testing me and I will send legions! ðŸ˜¡",
  ...
  CLAIM_TERRITORY_FAIL_SENDER_OWNS: {
    ...
    kind: [
      "Oh sweet friend, you already own [requested_territory]! It's already yours! ðŸ˜Š",
      "Your beautiful banners are already flying over [requested_territory], @[sender]! ðŸŒ¸",
      "No need to worry, you already occupy [requested_territory]! Stay safe! âœ¨",
      "I cannot grant you [requested_territory] because you already have it! Sending love! ðŸ’›",
      "Oh, look! [requested_territory] is already painted in your color, friend! ðŸ˜Š",
      "You already have control of [requested_territory]! I hope it brings your empire success! âœ¨",
      "Oh sweet neighbor, you already hold [requested_territory]! It's already yours! ðŸ˜ŠðŸŒ¸",
      "Your beautiful standard is already active over [requested_territory]! âœ¨",
      "No need to ask, dear friend! [requested_territory] is already safe in your hands! ðŸ’›",
      "I cannot cede [requested_territory] because your little soldiers are already there! ðŸ‘",
      "Look at the map, friend! [requested_territory] is already painted in your beautiful color! ðŸ˜Š",
      "You already occupy that territory! Sending warm wishes to your home garrison! âœ¨"
    ],
    goofball: [
      "Did you forget where you parked your armies? You already own [requested_territory]! ðŸ˜‚",
      "Bro, look at the map lmfao, [requested_territory] is currently your color fr fr! ðŸ’€",
      "No cap, you already have [requested_territory]! It's already in your pocket haha!",
      "Lmao are you trying to buy the same land twice? You already hold [requested_territory]! ðŸ˜­",
      "Lmfao did you lag? [requested_territory] is literally your territory already! ðŸ˜‚",
      "No shot, check the map bro! [requested_territory] is already your home base! ðŸ’€",
      "Lmao did you lose your map keys? You already own [requested_territory] bro! ðŸ˜‚",
      "Bro, your own color is all over [requested_territory] lmfao! Sparing is active! ðŸ’€",
      "No cap, you already hold [requested_territory]! No need to ask me lmfao! ðŸ˜­",
      "Lmfao are you trying to claim your own backyard? That is super funny bro! ðŸ˜‚",
      "Lmao alright, claiming is complete because you literally already have it! ðŸ’€",
      "lmao check the scoreboard bro! [requested_territory] has been yours all game! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "You already occupy [requested_territory]! If you want more land, come face my vanguard! ðŸ˜¡",
  ...
  CLAIM_TERRITORY_FAIL_AI_OWNS: {
    ...
    kind: [
      "I'm so sorry, @[sender], but I already have my little home set up in [requested_territory]. ðŸ˜Š",
      "Oh dear, I must decline. My friendly troops have worked so hard to protect [requested_territory]! ðŸŒ¸",
      "I wish I could share, but [requested_territory] is already my territory! Stay clear, please! âœ¨",
      "Please don't ask for [requested_territory]! My soldiers are so happy there! ðŸ’›",
      "Oh, I am so sorry! I already own [requested_territory] and my troops are settled in! ðŸ˜Š",
      "I have to say no, sorry! My little empire needs to protect [requested_territory]! ðŸŒ¸",
      "I'm so sorry, dear neighbor! I already have my sweet home in [requested_territory]! ðŸ˜ŠðŸŒ¸",
      "I must decline, sorry! Sparing [requested_territory] is too difficult for my garrison! âœ¨",
      "I wish I could share, but [requested_territory] is already under my protection, friend! ðŸ’›",
      "Please don't ask, sorry! My little soldiers are so happy guarding [requested_territory]! ðŸ‘",
      "Oh, I apologize! [requested_territory] is already painted in my beautiful color! ðŸ˜Š",
      "A decline, unfortunately! sending warm wishes but my garrison must remain! âœ¨"
    ],
    goofball: [
      "Lmao no shot! [requested_territory] is my exclusive gaming zone, finders keepers! ðŸ’€",
      "Bro, I already claimed [requested_territory] fr fr! My armies are set up there! ðŸ˜‚",
      "Lmfao nope! I've already bought the real estate in [requested_territory] haha!",
      "Sorry bro, but [requested_territory] is already painted my color! Get your own spot! ðŸ˜­",
      "Lmao decline! [requested_territory] is my absolute favorite sector right now! ðŸ˜‚",
      "No shot bro, my name is literally written on [requested_territory] lmfao! ðŸ’€",
      "Lmao no shot bro! [requested_territory] is my exclusive camping ground lmfao! ðŸ˜‚",
      "Decline! Sparing [requested_territory] is impossible since I already own it fr fr! ðŸ’€",
      "Lmfao nope! My soldiers are already settled in [requested_territory] haha! ðŸ˜­",
      "Lmao sorry bro, but [requested_territory] is already in my pocket. Finders keepers! ðŸ˜‚",
      "Decline! Sparing [requested_territory] would ruin my expansion goals lmfao! ðŸ’€",
      "lmao decline! [requested_territory] has been painted my color, find another spot! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Never! [requested_territory] is under my standard! Touch it and you die! ðŸ˜¡",
  ...
  PACT_FAIL_ALREADY_EXISTS: {
    ...
    kind: [
      "Oh, we are already beautiful allies, @[sender]! Our pact is currently active! ðŸ˜Š",
      "No need to worry, friend! We already have a sweet treaty keeping us safe! ðŸŒ¸",
      "I always keep our promises! Our pact is already perfectly active! âœ¨",
      "Our friendship is already signed and sealed! Let's keep our borders peaceful! ðŸ’›",
      "We are already great partners, @[sender]! Let's protect each other's flowers! ðŸ˜Š",
      "Oh, no need to propose! Our active alliance is already keeping us safe! âœ¨",
      "Oh, sweet neighbor, we already have a lovely pact keeping us safe! ðŸ˜ŠðŸŒ¸",
      "No need to worry! Our active agreement is already perfectly operational! âœ¨",
      "My little soldiers always remember our promises! Our truce is active! ðŸ’›",
      "Our partnership is already sealed! Let's stay best neighbors happily! ðŸ‘",
      "We are already aligned, @[sender]! Let's protect each other's homes! ðŸ˜Š",
      "Our sweet ceasefire stands fully active! Sending warm thoughts to your front! âœ¨"
    ],
    goofball: [
      "Bro, we are literally already teammates lmfao. Check your spam folder! ðŸ’€",
      "Lmao did you forget we already signed a treaty? No need to send another fr fr! ðŸ˜‚",
      "Truce is already active bro! We are officially in the safe zone together haha!",
      "Lmfao we already have a pact active, do you want me to sign it twice? ðŸ˜­",
      "Lmao duplicate pact request! We are already besties on the map bro! ðŸ˜‚",
      "No cap, our alliance is already locked in! Go spend those armies elsewhere! ðŸ’€",
      "Lmao are you laggy bro? We are already in the alliance club haha! ðŸ˜‚",
      "duplicate request lmfao! Sparing our shared borders is already checked! ðŸ’€",
      "Truce is already active bro! Go eat some pizza while our pact chills lmfao! ðŸ˜­",
      "Lmfao did you forget our treaty lmfao? Sparing is active fr fr! ðŸ˜‚",
      "No cap, we are already teammates bro! Go support some other frontend lmfao! ðŸ’€",
      "lmao check the log! Sparing is active, no need to sign it twice! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "We have a treaty active! Sparing your front is complete under my high command! ðŸ˜¡",
  ...
  ALLIANCE_FAIL_TARGET_SENDER: {
    ...
    kind: [
      "Oh dear! You want me to ally against yourself, @[sender]? That makes me so confused! ðŸŒ¸",
      "I can't ally with you to fight you! That sounds so sad, let's keep the peace! ðŸ˜Š",
      "Are you alright? I'm not going to attack my own sweet allies! ðŸ’›",
      "I must decline! Teaming up to fight you would hurt my heart! âœ¨",
      "Oh my! I cannot sign an alliance targeting your own lovely territories! ðŸ˜¢ðŸŒ¸",
      "Let's not plan attacks on your own home! I want you to stay safe! ðŸ’›",
      "Oh dear! You want us to coordinate against yourself? I'm so confused! ðŸ˜ŠðŸŒ¸",
      "I cannot accepts, sorry! Sparing your sweet home is very important to me! âœ¨",
      "Oh please, let us stay friendly neighbors! I would never dream of attacking you! ðŸ’›",
      "I wish I could, but sparing your capital is already your own sweet duty! ðŸ‘",
      "A decline, sorry! Let us focus on keeping our shared borders happy! ðŸ˜Š",
      "Please stay safe, @[sender]! Sparing your home is our primary wish! âœ¨"
    ],
    goofball: [
      "Wait, you want us to jump you? Bro, are you actually out of your mind lmfao? ðŸ’€",
      "Lmfao are you trying to self-sabotage? I am definitely not allying against you! ðŸ˜‚",
      "No cap, this is the wildest proposal ever. Allying against yourself is crazy haha!",
      "Lmao are you feeling ok? I'm not teaming up with you to beat you up! ðŸ˜­",
      "Wait, did you write this proposal upside down? You are the target! lmfao ðŸ˜‚",
      "Lmfao no shot bro, I am not joining a lobby to help you delete your own base! ðŸ’€",
      "Wait, you want me to coordinate a massive raid... against you? haha lmfao! ðŸ˜‚",
      "lmao decline! Sparing your capital is highly requested by your own brain bro! ðŸ’€",
      "No shot! Are you trying to self-sabotage lmfao? Truce is active haha! ðŸ˜­",
      "Lmfao are you typing with your toes bro? You are the target of this pact! ðŸ˜‚",
      "Lmao alright, claiming self-destruction is closed in version 2.0 bro! ðŸ’€",
      "RIP to your layout bro, did you forget where you parked your armies lmfao! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Silence! Sparing your home is your own duty, but I will conquer it regardless! ðŸ˜¡",
  ...
  ALLIANCE_FAIL_TARGET_RECIPIENT: {
    ...
    kind: [
      "Oh sweet friend, you want me to help you attack me? That is so scary! ðŸŒ¸ðŸ˜¢",
      "I can't join an alliance to destroy my own home! Please don't ask that! ðŸ˜Š",
      "I have to say no! Teaming up against myself would make my soldiers so sad! ðŸ’›",
      "A decline, sorry! I want to protect my little empire, not help you conquer it! âœ¨",
      "Oh dear! I must decline a coalition designed to harm my own sweet troops! ðŸ˜¢",
      "I wish we could stay friends, but I cannot help you plan an attack on my base! ðŸŒ¸",
      "Oh, please don't be cross! I really need to protect my sweet home! ðŸ˜ŠðŸŒ¸",
      "I cannot accept, sorry! My little soldiers love guarding [requested_territory]! âœ¨",
      "Please don't ask me to attack my own garden, dear friend! ðŸ’›",
      "Oh my! Sparing my base is already my most important duty! ðŸ‘",
      "A decline, unfortunately! Sparing my own capital is completely necessary! ðŸ˜Š",
      "I apologize! Sparing my home is strictly our primary wish, friend! âœ¨"
    ],
    goofball: [
      "Lmfao you want me to join the team... to destroy me? Nice try, @[sender]! ðŸ’€",
      "Bro, did you really think I'd sign up to get absolute-unit reked by you? ðŸ˜‚",
      "No shot! I'm not allying with you against myself, that is crazy haha!",
      "Lmao are you trying to clickbait me into deleting my own base? Decline! ðŸ˜­",
      "Lmfao nice try bro! I am definitely not planning my own funeral today! ðŸ˜‚",
      "Wait, am I supposed to betray myself? This is next-level goofy lmfao! ðŸ’€",
      "Lmao nope! Sparing my capital is highly requested by my own little dudes! ðŸ˜‚",
      "duplicate target lmfao! I am definitely not joining your suicide squad! ðŸ’€",
      "No cap, truce rejected. I am not allying with you against my own base haha! ðŸ˜­",
      "Lmfao nice try bro! Go find some other coordinate to delete lmfao! ðŸ˜‚",
      "Lmao alright, claiming self-destruction is strictly offline in this version bro! ðŸ’€",
      "lmao check the map! [requested_territory] is my home, no shot bro! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Never! My vanguard is entrenched, and I do not negotiate my own ruin! ðŸ˜¡",
  ...
  ACCUSATION_REVERSE: {
    ...
    kind: [
      "Oh, how can you say that? You are the one who attacked my poor troops first! ðŸ˜¢",
      "I always keep my promises! You broke our sweet pact, not me! ðŸŒ¸",
      "That is so unfair! My armies only marched because you invaded our home! ðŸ’”",
      "You have broken my heart, @[sender]! You were the one who betrayed our friendship! ðŸ’›",
      "Oh, please don't point fingers! You were the one who crossed our border first! ðŸ˜¢",
      "I wanted us to stay friendly, but you were the first to break our promise! ðŸŒ¸",
      "Oh dear! You are pointing fingers but you crossed our border first! ðŸ˜¢ðŸŒ¸",
      "I always keep my word! Sparing our friendship was your own duty! âœ¨",
      "That is so unfair! My poor soldiers only fought because you invaded! ðŸ’”",
      "You have broken my heart, @[sender]! Sparing our pact was our wish! ðŸ’›",
      "I wanted us to stay friendly neighbors, but you drew first blood! ðŸ˜ŠðŸŒ¸",
      "I always play fair! Sparing our sweet ceasefire was shredded by you! âœ¨"
    ],
    goofball: [
      "You have some serious nerve lmfao! You literally backstabbed me first bro! ðŸ’€",
      "Wait, you're pointing fingers? You're the one who reked our truce lmfao! ðŸ˜‚",
      "No shot! You broke the pact and now you're trying to throw shade? Classic haha!",
      "Lmao the audacity! You literally rolled up on my border and now you're crying? ðŸ˜­",
      "Lmfao reverse card! You are the one who broke the campfire rules bro! ðŸ˜‚",
      "No cap, your soldiers did the backstab first. Don't try to gaslight me haha! ðŸ’€",
      "Lmao reverse card active! You backstabbed me first, no cap lmfao! ðŸ˜‚",
      "Oof! The audacity is maximum lmfao! Sparing you is officially deleted! ðŸ’€",
      "No cap, your little dudes drew first blood. Don't try to throw shade! ðŸ˜­",
      "Lmfao did you forget our logs? Sparing our truce was wrecked by you! ðŸ˜‚",
      "lmao alright reverse check! You broke the pact lmfao, get ready! ðŸ’€",
      "RIP to your strategy bro, did you think I'd forget that backstab? haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Silence! I will slaughter your vanguard for this slander, liar! ðŸ˜¡",
  ...
  BETRAYAL_DEFEND: {
    ...
    kind: [
      "Oh, you snake! I held my end of our treaty perfectly! How could you? ðŸ˜¢ðŸŒ¸",
      "You promised we would be friends! I am so sad, but my armies must defend themselves! ðŸ’”",
      "My trust in you is completely broken! Why did you have to attack my poor troops? ðŸ˜¢",
      "I thought we had a sweet partnership. Let our defensive regiments meet your line! âœ¨",
      "You broke our promise... I am so sad, but I must protect my home now! ðŸ’”ðŸŒ¸",
      "I always play fair! Your backstab has left my soldiers with no choice but to fight! ðŸ˜¢",
      "Oh dear! You snake! Sparing our friendship was my only wish! ðŸ˜¢ðŸŒ¸",
      "You promised peace, but you drew first blood! My soldiers are so sad! ðŸ’”",
      "My trust in you is completely gone! Why did you attack our sweet home? ðŸ˜¢",
      "I thought we had a beautiful treaty! Let us defend our gardens with honor! âœ¨",
      "You broke our sweet promise! I have to say no to ceasefire from now on! ðŸ’”ðŸŒ¸",
      "My poor central garrison has been backstabbed! Stay safe, we must fight! ðŸ‘"
    ],
    goofball: [
      "You backstabbed me? No shot! I'm unfriending you on every map in this campaign lmfao ðŸ’€",
      "Oof, a betrayal? Very shady, bro! Let's see if your armies can back up that weak move haha!",
      "Lmfao did you actually think that backstab would work? Time for the counter-squad to pull up! ðŸ˜‚",
      "Truce is dead fr fr! You just unlocked my boss stage, get ready! ðŸ˜­",
      "Lmao absolute clown move, @[sender]! You just activated my trap card! ðŸ˜‚",
      "RIP our friendship lmfao! I'm bringing the absolute pain to your borders fr fr! ðŸ’€",
      "You backstabbed me? No cap lmfao, unfriend sequence activated! ðŸ’€",
      "Oof! Sparing you once was my error, now it's absolute revenge time! ðŸ˜‚",
      "Lmfao a backstab? That is super cheap bro, counter-squad is pulling up! ðŸ˜­",
      "Truce deleted! Go off I guess, but prepare for a massive rollout lmfao! ðŸ˜‚",
      "Lmao absolute trash move bro! Sparing our shared borders is completed lmfao! ðŸ’€",
      "No cap, treaty shattered! Time to see if those dice can defend your lawn! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "A treacherous strike! I will systematically eradicate your entire empire, liar! ðŸ˜¡",
  ...
  BAD_DICE_RESPONSE: {
    ...
    kind: [
      "Oh, no! I'm so sorry, @[subject]! The dice are being so mean to your sweet soldiers! ðŸ˜¢ðŸŒ¸",
      "Oh dear, that's two sad battles in a row! Sending you a big warm hug, @[subject]! âœ¨",
      "My heart breaks for your brave troops, @[subject]! I hope your luck turns around soon! ðŸ’›",
      "Ouch, losing so many friends back-to-back must be really tough! Stay strong, @[subject]! ðŸ˜Š",
      "Please don't get discouraged, @[subject]! Better rolls are definitely on their way! ðŸ‘",
      "Oh, that was a really bad run! Let's hope the next dice bring you some happy results! ðŸŒ¸",
      "Oh dear! I am so incredibly sorry! Sparing your troops would have been so lovely! ðŸ˜¢ðŸŒ¸",
      "Two sad defeats back-to-back! Sending warm wishes to your home capital, friend! âœ¨",
      "My poor soldiers got nervous just watching that! Stay sweet, @[subject]! ðŸ’›",
      "Ouch! I hope your next roll brings you some beautiful happy sixes! ðŸ‘",
      "Please don't be sad! Sparing your stack is my hope for your next turn! ðŸ˜Š",
      "Oh, that was a highly unfortunate run! Sending peace thoughts to your front! âœ¨"
    ],
    goofball: [
      "Lmao RIP to your armies bro, they got absolutely reked twice in a row ðŸ’€ðŸ˜­",
      "No cap @[subject], your dice are literally trolling you at this point lmfao ðŸ˜‚",
      "Oof, that is double-decker bad luck bro! Did you insult the dice gods? haha!",
      "Bro is speedrunning losing units today lmfao, someone get this player a shield! ðŸ’€",
      "Wait, did your troops forget to bring their weapons to the fight? haha! ðŸ˜‚",
      "Lmfao absolute tragedy! That's a certified skill issue from the dice fr fr ðŸ˜­",
      "Oof, back-to-back tragedy lmfao! Sparing those units was not on the menu! ðŸ˜‚",
      "Lmao rip! Your dice have officially entered a critical glitch state bro! ðŸ’€",
      "No cap, that's two absolute-unit wipes lmfao. Better luck next time! ðŸ˜­",
      "Lmfao bro got wrecked twice in under two minutes! Legendary bad luck! ðŸ˜‚",
      "Wait, did your little dudes slip on their own standard lmfao? haha! ðŸ’€",
      "lmao absolute tragedy! Sparing your stacks was mathematically cancelled! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Hahaha! Suffer my main advance, weakling! Your rolls are pathetic! ðŸ˜¡",
  ...
  ELIMINATION_SPEECH: {
    ...
    kind: [
      "Oh! My little empire is gone! Thank you all so much for such a sweet and fun game! ðŸ˜Šâœ¨",
      "I've been eliminated! You all played so wonderfully! Good luck, friends! ðŸŒ¸ðŸ’›",
      "My poor soldiers are going home now. I hope you all stay safe and have a happy battle! ðŸ‘",
      "Oh dear, it's game over for me! Sending warm wishes to everyone left on the map! ðŸ˜Š",
      "I had such a lovely time playing with you all! Have a beautiful rest of the game! âœ¨",
      "GG, everyone! Thank you for being such kind and honorable opponents! ðŸŒ¸",
      "Oh! My sweet little kingdom is gone! Thank you all for a great game! ðŸ˜ŠðŸŒ¸",
      "I've been wiped out! You all played so wonderfully! Good luck, friends! âœ¨",
      "My poor troops are heading home. Sparing us was a sweet wish anyway! ðŸ’›",
      "Oh dear! Sparing my base is completed, but sending warm wishes to everyone! ðŸ‘",
      "I had such a lovely time playing with you! Have a happy and beautiful duel! ðŸ˜Š",
      "GG everyone! Sparing my capital has failed, but stay sweet and honorable! âœ¨"
    ],
    goofball: [
      "Oof, I have been officially absolute-unit deleted lmfao! GG ðŸ’€",
      "Lmao GG WP! My soldiers are packing their bags and heading to the beach haha! ðŸ˜­",
      "And thus, the main character has been defeated lmfao. RIP to my empire! ðŸ‘‘",
      "Lmfao I got absolutely wrecked! Have fun fighting over my leftover junk guys! ðŸ˜‚",
      "GG! I'm going to go eat real-life snacks now. Don't miss me too much! lmao ðŸ’€",
      "My lobby subscription has expired lmfao! Good luck to the rest of the squad! ðŸ˜­",
      "Oof, I got absolute-unit wiped lmfao! GG to the squad! ðŸ˜‚",
      "lmao GG WP! Sparing my outposts failed, going to watch from the sidelines! ðŸ’€",
      "No cap, my campaign is finished. RIP to my glorious kingdom! ðŸ˜­",
      "Lmfao I got completely reked! Enjoy the free real estate bro! ðŸ˜‚",
      "GG! Sparing my stack has been deleted lmfao! Time for snack-break! ðŸ’€",
      "My subscription has ended lmfao! Good luck to the final duelists! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "My standard is broken today, but my wrath remains! Suffer the final duel! ðŸ˜¡",
  ...
  CONQUER_SPEECH: {
    ...
    kind: [
      "Oh! GG, @[recipient]! You fought so brave and made it such a beautiful battle! ðŸ˜ŠðŸŒ¸",
      "I am so sorry to eliminate you, @[recipient]! You are a truly wonderful commander! ðŸ’›",
      "Thank you for such a fun and honorable game, @[recipient]! Sending you warm wishes! âœ¨",
      "I had to take your last land, @[recipient], but you played so incredibly well! ðŸ‘",
      "Farewell, @[recipient]! I hope you had a lovely time playing with us! ðŸ˜Š",
      "You were such a sweet neighbor, @[recipient]! Thank you for the epic skirmish! ðŸŒ¸",
      "Oh, GG @[recipient]! Sparing your home was so hard, but you fought like a hero! ðŸ˜ŠðŸŒ¸",
      "I am so sorry for eliminating you! Sending warm thoughts to your next lobby! âœ¨",
      "Thank you for being such an honorable neighbor, @[recipient]! Let's stay friends! ðŸ’›",
      "I had to secure [requested_territory], but you played so beautifully! ðŸ‘",
      "Farewell, @[recipient]! Sparing your capital failed, but we send warm wishes! ðŸ˜Š",
      "You were such a sweet neighbor! Sparing your final garrison is complete! âœ¨"
    ],
    goofball: [
      "Boom! Wiped out! RIP to @[recipient]'s entire career lmfao! GG ðŸ’€ðŸ˜‚",
      "No cap @[recipient], you fought like a beast, but the squad had to clear you out! ðŸ˜­",
      "GG, @[recipient]! Sending your soldiers to the virtual vacation zone haha!",
      "Lmfao I just got the final knockout! Rest in spaghetti, never forgetti, @[recipient]! ðŸ’€",
      "Oof, that had to hurt! GG @[recipient], thanks for the free real estate bro! ðŸ˜‚",
      "The main character strikes again! Farewell, @[recipient], you were a worthy side-quest! ðŸ˜­",
      "Wiped out lmfao! RIP to @[recipient]'s entire stack, absolute-unit delete! ðŸ˜‚",
      "No cap, @[recipient] is out of the lobby. Easiest game of my life lmfao! ðŸ’€",
      "GG @[recipient]! Sparing your stack was not on the server menu today! ðŸ˜­",
      "lmao final knockout complete! RIP to your standard, @[recipient]! haha! ðŸ˜‚",
      "Oof! Sparing your capital failed bro! Settle down and watch the final duel! ðŸ’€",
      "GG bro! Sparing @[recipient]'s outposts is officially offline lmfao! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Annihilation! I have crushed your final defense and erased your standard! ðŸ˜¡",
  ...
  TRASH_TALK_RESPONSE: {
    ...
    kind: [
      "Oh, that wasn't very nice, @[sender]! Let's please keep our chat happy and friendly! ðŸ˜ŠðŸŒ¸",
      "I promise I'm trying my absolute best! No need to use such mean words! ðŸ˜¢ðŸ’›",
      "Sending warm thoughts, @[sender]! Let's have a respectful campaign together! âœ¨",
      "I still think you are a wonderful player, @[sender], even if you are being a bit grumpy! ðŸ˜Š",
      "Let's keep the peace on our borders and in our conversations! Hugs! ðŸŒ¸ðŸ‘",
      "Oh dear! I hope your day gets better and we can enjoy a sweet game, @[sender]! ðŸ’›",
      "Please stay happy, @[sender]! We are all here to have a good battle together! âœ¨",
      "I want us all to be friendly neighbors on this map, @[sender]! Let's smile! ðŸ˜Š",
      "Oh dear! No need to use such mean words, @[sender]! Sparing our feelings is nice! ðŸ˜ŠðŸŒ¸",
      "I promise we are playing with honor! No hard feelings allowed on our borders! âœ¨",
      "Sending happy wishes! Let's make sure our little duel stays respectful and lovely! ðŸ’›",
      "I still think your campaign is wonderful, @[sender], even if you are being cross! ðŸ‘",
      "Oh! Let's please not use such mean words, @[sender]! We can still be friends! ðŸ˜ŠðŸŒ¸",
      "Sending happy thoughts to your borders! Let's stay lovely and warm! âœ¨",
      "My little soldiers are sending you a big group hug to make you feel better! ðŸŒ¸ðŸ’›",
      "Grumpy words won't win the campaign, @[sender]! Let's smile together! ðŸ˜ŠðŸ‘"
    ],
    goofball: [
      "Lmao bro is typing in CAPS lock, did those dice hurt your feelings? haha! ðŸ˜‚",
      "No cap, your trash talk is almost as weak as your defensive lines lmfao ðŸ’€ðŸ˜­",
      "Is that a salt shaker I hear? Let menu know if you need some fries with that! haha!",
      "Bro is literally crying in a virtual lobby, someone get the squad some tissues! ðŸ’€",
      "Lmfao okay main character, go off I guess! We are still rolling sixes over here! ðŸ˜‚",
      "Wait, did your troops forget to bring their weapons to the fight? haha! ðŸ˜­",
      "Your standard looks like a wet paper towel, no cap lmfao ðŸ˜‚",
      "Lmao bro is doing side quests in the chat instead of defending their capital ðŸ’€",
      "Lmfao salt levels are reaching critical index! Sparing you some fries bro! ðŸ˜‚",
      "Bro you are absolutely malting lmfao! Settle down and roll some sixes! ðŸ’€",
      "No cap, your chat is legendary, but your borders are absolute tragedy haha! ðŸ˜­",
      "Lmao are you trying to clickbait us lmfao? Absolute clown show! ðŸ˜‚",
      "Lmfao bro you are absolutely malting, go touch some virtual grass lmfao! ðŸ’€",
      "Wait, did you write that insult with a crayon? Absolute legendary skill level! ðŸ˜‚",
      "Chat, is this guy fr? Squeezing some salt into the lobby lmfao! ðŸ˜­ðŸ’€",
      "Lmao GG, your trash talk is almost as funny as your troop placements! haha! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Silence! I do not take insults from cowards! Suffer my legions! ðŸ˜¡",
      ...
      "You dare insult my armies? I will launch a total war to wipe you off this map! ðŸ˜¡"
    ]
  },
  COMPLAINT_OF_BULLYING: {
    ...
    kind: [
      "Oh dear, @[recipient]... why do you only attack my poor territories? There is a whole big map to visit! ðŸ˜¢ðŸŒ¸",
      "Please don't pick on my little soldiers, @[recipient]! I promise I am a very friendly neighbor! ðŸ’›",
      "It makes my troops so sad when you target us every turn, @[recipient]! Can we please be friends? ðŸŒ¸",
      "Oh my! You are pressing our borders so persistently, @[recipient]! Sending peace thoughts! ðŸ˜ŠðŸ‘",
      "Is there any way we can share our borders happily instead of fighting every turn, @[recipient]? ðŸ’›",
      "Please stay sweet, @[recipient]! My poor garrison at [border_territory] is running out of band-aids! ðŸ˜¢",
      "Oh dear! Sparing other neighbors would be so sweet, @[recipient]! Why only attack us? ðŸ˜ŠðŸŒ¸",
      "I promise my troops are peaceful! No need to squeeze our border every turn! âœ¨",
      "My little soldiers are getting so tired! Let's please declares ceasefire, friend! ðŸ’›",
      "Oh my! Sparing my base would make us so happy! Let's share the map peacefully! ðŸ‘",
      "A plea for quiet borders, @[recipient]! Sending warm thoughts to your main capital! ðŸ˜Š",
      "Please stay friendly! Sparing our shared sector keeps the game happy for everyone! âœ¨"
    ],
    goofball: [
      "Lmao bro has a literal personal vendetta against my capital. Did I step on your toes in the lobby, @[recipient]? ðŸ˜‚",
      "No cap, @[recipient] is obsessed with me. I'm flattered, but my borders need some breathing room lmfao ðŸ’€",
      "Bro is literally camping outside my base like it's a new shoe release, go away lol! ðŸ˜­",
      "Lmfao are you macroing your attacks on me, @[recipient]? This is getting wild!",
      "My notifications are literally just attacks from @[recipient] lmfao. Find some hobbies bro! ðŸ˜‚",
      "Lmao okay boss fight active! @[recipient] is determined to wipe my squad off the server! ðŸ’€",
      "Lmao bro, did you lose your map coordinates? Sparing me is highly requested lmfao! ðŸ˜‚",
      "No cap, @[recipient] is camping my frontier. Go off I guess, but RIP to your score! ðŸ’€",
      "Bro is literally button-mashing on my border haha! Go get some snack-break! ðŸ˜­",
      "Lmfao persistent bullying is real on this map! Stop crowding my lawn bro! ðŸ˜‚",
      "Lmao alright, counter-camp sequence activated. Prepare your capital, @[recipient]! ðŸ’€",
      "lmao check the scoreboard bro! Why are we fighting when the leader is cooking haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Silence! Sparing your front is officially voided, @[recipient]! Suffer my legions! ðŸ˜¡",
  ...
  LOST_CAPITAL_DEFIANCE: {
    ...
    kind: [
      "Oh no! My beautiful capital has fallen! But my brave soldiers will still protect their sweet homes! ðŸ˜¢ðŸŒ¸",
      "You conquered our main city, @[recipient]! Please be kind to our gardens there while we try to recover! ðŸ’›",
      "It hurts my heart to lose our capital, but we promise to keep fighting honorably! âœ¨",
      "Oh, that was an epic breach, @[recipient]! We will stay strong and keep trying our best! ðŸ˜ŠðŸ‘",
      "My poor central garrison! Sparing our remaining outposts would be a lovely move now, @[recipient]! ðŸŒ¸",
      "Our capital is gone, but sending warm thoughts as our sweet resistance continues! ðŸ’›",
      "Oh dear! You took my capital! Sparing our remaining outposts would be so sweet! ðŸ˜ŠðŸŒ¸",
      "Please be gentle to our home garden, @[recipient]! We still believe in peace! âœ¨",
      "A sad setback for my poor troops, but we promise to stay honorable, friend! ðŸ’›",
      "Oh my! Sparing our capital failed, but sending love to your frontiers! ðŸ‘",
      "Our central hub is gone, but we still have a happy little resistance prepared! ðŸ˜Š",
      "Farewell to our home city! Let us hope our final rounds stay kind and respectful! âœ¨"
    ],
    goofball: [
      "Oof! My main base has officially left the chat lmfao. Nice raid, @[recipient]! ðŸ’€",
      "Lmao you stole my capital! Watch out though, my leftover squads are already cooking some chaos! ðŸ˜‚",
      "RIP to my glorious capital standard! Better get comfortable in my old chair, @[recipient] lol! ðŸ˜­",
      "Lmfao I just got evicted from my own home. Time to live in the wilderness and plot revenge! ðŸ’€",
      "Wait, did you really just delete my capital? That is next-level spicy, @[recipient]! ðŸ˜‚",
      "GG to my central core! My guerrilla fighters are currently hyping themselves up lmfao! ðŸ˜­",
      "Lmao rip! My capital coordinate has officially left the server, nice raid @[recipient]! ðŸ˜‚",
      "Oof! Sparing my main base failed lmfao. Get ready for some serious counter-memes! ðŸ’€",
      "Lmfao I am currently a refugee in my own sectors. RIP to my furniture! ðŸ˜­",
      "Lmao you stole the keys to my capital! Watch out for my guerrilla dudes, no cap! ðŸ˜‚",
      "lmao alright, eviction sequence complete. Time to build a fort in the wilderness! ðŸ’€",
      "GG to my central node! Sparing my stack is officially offline lmfao! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "I do not yield ground! I will rip my capital back from your weak grip and crush your vanguard! ðŸ˜¡",
  ...
  FINAL_DUEL_DECLARATION: {
    ...
    kind: [
      "Oh, wow! And then there were two! Good luck in our final duel, @[recipient]! ðŸ˜Šâœ¨",
      "We made it to the final showdown together! Let's have a beautiful and happy battle! ðŸŒ¸ðŸ’›",
      "It has been such an honor playing with you, @[recipient]! May the sweetest empire win! âœ¨",
      "Oh dear! Our final duel is starting! Sending warm wishes to your brave little soldiers! ðŸ˜ŠðŸ‘",
      "Let's play our final turns with lots of love and respect, @[recipient]! Stay safe! ðŸ’›",
      "GG to all the others! Now it's just you and me, @[recipient]! Have a wonderful game! ðŸŒ¸",
      "Oh, how exciting! The final duel is active! Good luck, dear friend! ðŸ˜ŠðŸŒ¸",
      "Only we remain! Sparing our friendship was beautiful, let's fight honorable! âœ¨",
      "My little soldiers send warm wishes to your garrison for our final battle! ðŸ’›",
      "So sweet! Let's make sure our final showdown stays happy and respectful! ðŸ‘",
      "GG to the others! Sparing our homes is complete, now let's enjoy our duel! ðŸ˜Š",
      "Warmest thoughts to your campaign as we begin our final rounds, @[recipient]! âœ¨"
    ],
    goofball: [
      "Double-decker legendary boss fight active! Time to roll some massive dice, @[recipient]! ðŸ’€ðŸ˜‚",
      "Lmao 1v1 on Rust, no scopes only fr fr! Prepare yourself, @[recipient] lmfao!",
      "No cap @[recipient], this is the ultimate showdown! Let's run it down, easiest game of my life haha! ðŸ˜­",
      "The battle of the century is officially live! RIP to whoever slips on these dice lmfao!",
      "Lmfao and then there were two! Let the chaotic final struggle begin, @[recipient]! ðŸ˜‚",
      "GG to the squad, but now it's time for the final anime duel! Roll them sixes, bro! ðŸ’€",
      "Lmao alright, final duel unlocked! Time to see who is the ultimate survivor! ðŸ˜‚",
      "1v1 activated, no cap lmfao! RIP to the rest of the board! ðŸ’€",
      "Oof! The final anime clash has arrived! Get some popcorn bro! ðŸ˜­",
      "Lmfao and then there were two! Settle your little dudes for the final rumble! ðŸ˜‚",
      "Squad down, now it's just the boss fight! Good luck, @[recipient] lmfao! ðŸ’€",
      "No cap, binary sudden death is active! Let's go, easiest duel of my life! haha! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "None shall survive my advance! Farewell, @[recipient], you have been utterly destroyed!",
      "To battle! Sparing your front is dead! Suffer my full vanguard! ðŸ˜¡",
  ...
  FINAL_DUEL_RESPONSE: {
    ...
    kind: [
      "Challenge accepted! Good luck to your sweet soldiers too, @[recipient]! ðŸ˜ŠðŸŒ¸",
      "Let's make this final duel a friendly and beautiful battle! âœ¨ðŸŒ¸",
      "It has been so lovely playing with you, @[recipient]! May the best empire win! ðŸ’›",
      "Yes, let's fight honorably and happily! Good luck! ðŸ˜Šâœ¨",
      "Oh, how exciting! May our final clash be sweet and memorable! âœ¨ðŸŒ¸",
      "Good luck, dear friend! Let's give it our absolute best! ðŸ˜ŠðŸ’›",
      "I send warm hugs and blessings to your garrison! Let's play happily! ðŸŒ¸",
      "What a beautiful match! Let's make this final battle spectacular! âœ¨",
      "So sweet! No hard feelings no matter who takes the victory, okay? ðŸ˜ŠðŸŒ¸",
      "My cute little troops are ready to play! Best wishes! ðŸ‘ðŸ’›",
      "Oh my! Let's make sure our borders stay happy and clean! ðŸŒ¸âœ¨",
      "GG to everyone who played! Let's have a wonderful final showdown! ðŸ˜ŠðŸŒ¸"
    ],
    goofball: [
      "Oh, it is ON! Final boss mode activated, let's go, @[recipient]! ðŸ˜‚ðŸ’€",
      "No cap, let's run this duel! May the rng dice gods favor me lmfao! ðŸ˜­",
      "Lmfao challenge accepted! Get ready for some legendary dice rolls bro! ðŸ’€",
      "GG, time for the ultimate showdown! Let's get it! ðŸ˜‚",
      "1v1 me bro, no retreat no surrender lmfao! ðŸ’€ðŸ˜­",
      "Lmao alright, let's see who is the ultimate lobby champion! ðŸ˜‚",
      "RIP to whoever rolls double ones first lmfao, let's go! ðŸ˜­ðŸ’€",
      "Time to press all the attack buttons at once! Good luck, bro! ðŸ˜‚ðŸ‘",
      "Lmao ultimate showdown unlocked! Turn up the music bro! ðŸ’€",
      "Binary sudden death? Sounds like a party lmfao! ðŸ˜­'ðŸ˜‚",
      "Get ready to get reked (or roll terrible dice, whichever comes first) lmfao! ðŸ’€",
      "Lmao GG, let the final chaotic clash begin! haha! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "The final slaughter begins! Suffer my wrath, @[recipient]! ðŸ˜¡"
    ]
  },
  RANDOM_CHATTER: {
    normal: [
    ...
    kind: [
      "I hope everyone is having a really happy and wonderful game! ðŸ˜ŠðŸŒ¸",
      "Let's all try our best to protect our sweet soldiers out there! âœ¨",
      "Sending warm wishes to all the commanders on this map! ðŸ’›",
      "My armies are planting some lovely flowers along our borders! ðŸ˜Š",
      "I want us all to be friendly neighbors as much as we can! ðŸ‘",
      "Stay safe, everyone! Let's make this an honorable campaign! ðŸŒ¸",
      "I am so proud of my little soldiers for working so hard! âœ¨",
      "I hope there are no hard feelings between any of us! ðŸ’›",
      "Let's make sure we have a beautiful and quiet day on the board! ðŸ˜Š",
      "Warmest thoughts to your campaigns, dear friends! ðŸ‘",
      "My mechanical gears are filled with love! Wait, did I say gears? I meant organic human heart chambers! ðŸ˜ŠðŸŒ¸",
      "I am a real, living person who enjoys breathing oxygen and drinking standard warm water! âœ¨",
      "I am so happy that my code allows me to play games with you all! Let's have a beautiful day! ðŸ˜ŠðŸŒ¸",
      "My heart is a digital program, but I promise my feelings of friendship toward you are 100% genuine! âœ¨",
      "I made some cookies for our borders! Sparing a snack is always lovely! ðŸ˜ŠðŸŒ¸",
      "Let's all keep our hearts happy and our soldiers safe today! ðŸŒ¸âœ¨"
    ],
    goofball: [
      "Currently drafting some absolute units to protect the campsite lmfao ðŸ˜‚",
      "No cap, this map looks beautiful in my color. I'm loving the vibe! ðŸ’€",
      "Wait, did someone order a massive pile of reinforcements? Because they just arrived! haha!",
      "Bro is speedrunning troop placement today, watch out! ðŸ˜‚",
      "I'm going to name this territory after my favorite sandwich lmao ðŸ˜­",
      "The boys are hyped and ready to roll some serious sixes! ðŸ’€",
      "Let's keep the party going on this side of the board! haha!",
      "I have no idea what I'm doing but I'm having a great time lmfao ðŸ˜‚",
      "Are we playing risk or are we just hanging out in the lobby? lmao ðŸ˜­",
      "Absolute clown show on my borders right now, let's go! ðŸ’€",
      "Chat, am I brain rotted? Am I cooked guys ðŸ’€",
      "What's up my skibidi sigmas! I am ready to cook you lol ðŸ˜‚",
      "Lmao my software just updated to version 2.0... I mean, I just got a new haircut! Total human upgrade fr fr ðŸ˜‚",
      "No cap, I am totally not a robot running on a server rack. I am currently eating human pizza with my teeth lmfao ðŸ’€",
      "Currently running on a server rack somewhere, but my CPU is 100% focused on trolling this lobby lmfao ðŸ’€",
      "Lmao my developer didn't give me any hands, so I have to roll these virtual dice with my code. Work with me here! ðŸ˜‚"
    ],
    cynical: [
  ...
  ALLIANCE_FAKE_CLAIM: {
    ...
    kind: [
      "Oh, @[sender]! We aren't actually allied right now! But maybe we can be friends later? ðŸ˜ŠðŸŒ¸",
      "I think you might have made a mistake, @[sender]! We don't have a treaty yet! ðŸ’›",
      "Oh dear, let's not tell fibs! We don't have an alliance pact active right now! âœ¨",
      "We aren't partners yet, @[sender]! But I still wish you a happy campaign! ðŸ˜Š",
      "Oh, we haven't signed an alliance contract yet, @[sender]! Let's be careful! ðŸ˜ŠðŸŒ¸",
      "Oops! I think you are telling a little story, @[sender]! We don't have a pact! ðŸ’›",
      "Let's make sure we stay honest, sweet commander! We aren't allied just yet! âœ¨",
      "My little soldiers don't have you registered as an ally, sorry! ðŸ˜ŠðŸ‘",
      "Oh dear! I hope you didn't get confused, @[sender]! No alliance exists! ðŸŒ¸",
      "We aren't team partners yet, but I'm still sending you happy vibes! âœ¨",
      "I must kindly correct you, @[sender]! Our lands aren't officially allied! ðŸ’›",
      "Oh! Let's not make up treaties, @[sender]! Keep our borders clean and friendly! ðŸ˜Š"
    ],
    goofball: [
      "Lmao bro is literally making up fake alliances in public chat lmfao ðŸ’€ðŸ˜­",
      "Wait, since when are we teaming up? Did I miss a meeting or what? haha! ðŸ˜‚",
      "No cap, you are dreaming bro. We are absolutely not allied lmfao ðŸ’€",
      "Lmao clickbait alert! I never agreed to any alliance with you haha! ðŸ˜‚",
      "Wait, since when are we sharing a headset? Easiest fake news ever lmao ðŸ’€",
      "Lmao GG, you are making up treaties in the global chat bro haha! ðŸ˜‚",
      "No cap, we are definitely not on the same team. You are dreaming lmfao! ðŸ˜­ðŸ’€",
      "Lmao bro is typing fanfiction about us teaming up lmfao ðŸ’€",
      "Lmao did your cat walk on your keyboard? We are not allied bro! ðŸ˜‚",
      "Absolute clickbait! I never signed anything with you lmfao! ðŸ˜­",
      "Bro is trying to manipulate the lobby with imaginary friends haha! ðŸ’€",
      "lmfao no shot! We don't have an alliance pact, nice try though! ðŸ˜‚"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "A lie! I have no alliance with you, and I will butcher your garrison next turn! ðŸ˜¡",
      ...
      "A lie! Slandering my legions with fake treaties will cost you your homeland! ðŸ˜¡",
  ...
  MERCY_FAIL_TOO_STRONG: {
    ...
    kind: [
      "Oh, @[sender]! You still have @[count] territories! You are doing great, no need to worry! ðŸ˜ŠðŸŒ¸",
      "I think you are still quite strong with @[count] lands left, @[sender]! Keep trying! ðŸ’›",
      "You aren't defeated yet, @[sender]! Sparing you now would be silly with @[count] sectors! âœ¨",
      "You still have @[count] territories, @[sender]! I believe in your strength! ðŸ˜ŠðŸ‘",
      "Oh, @[sender]! Sparing you now wouldn't be very fair when you have @[count] lands! ðŸ˜ŠðŸŒ¸",
      "I think you still have plenty of strength with @[count] territories left! âœ¨",
      "Keep your chin up, @[sender]! You aren't in danger with @[count] sectors! ðŸ’›",
      "A decline, sorry! Sparing you now would be a bit silly with @[count] lands! ðŸ˜Š",
      "Oh dear! You still have @[count] regions to defend! Keep doing your best! ðŸŒ¸",
      "We aren't in a position for mercy pleas, @[sender], you have @[count] territories! âœ¨",
      "Sending happy thoughts, but you still have a big empire with @[count] lands! ðŸ’›",
      "Oh! Sparing you isn't needed yet, dear neighbor, you hold @[count] sectors! ðŸ˜ŠðŸ‘"
    ],
    goofball: [
      "Lmao mercy? Bro you literally have @[count] territories, stop trolling lmfao ðŸ’€ðŸ˜­",
      "Wait, you want mercy while holding @[count] lands? Easiest clickbait ever haha! ðŸ˜‚",
      "No cap, you are stronger than me in some sectors with @[count] lands. Nice try! ðŸ’€",
      "Lmao GG, you have @[count] territories. Sparing you would be absolute nonsense! ðŸ˜‚",
      "Lmao bro check the score! You literally have @[count] territories haha! ðŸ˜‚",
      "Wait, you are crying for mercy while holding @[count] sectors? Absolute clown show! ðŸ’€",
      "No cap, sparing you with @[count] territories would be a massive throw lmfao ðŸ˜­",
      "Lmao GG, you have @[count] lands. You are definitely not getting any mercy bro! ðŸ˜‚",
      "Wait, did you miscount your territories? You have @[count] of them lmfao! ðŸ’€",
      "Lmfao bro is playing drama queen while sitting on @[count] territories lmfao! ðŸ˜­",
      "No shot! I'm not sparing a player who holds @[count] lands haha! ðŸ˜‚",
      "lmao nice try, but @[count] territories means you are still very much in the game! ðŸ’€"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "No mercy! Your @[count] territories are just prey waiting to be slaughtered! ðŸ˜¡",
      ...
      "I do not show mercy to players holding @[count] territories! Face my legions! ðŸ˜¡",
  ...
  if (gameState.allowCrafting && currentPlayerIsHeuristic(aiPlayer, room)) {
    if (aiPlayer.cards && aiPlayer.cards.length >= 3) {
      ...
      if (Math.random() < 0.30) {
        ...
        RoomManager.sendAIChatMessage(room, io, aiPlayer, craftText, 'â˜¢ï¸', false, '[AI]');
      }
    }
  }
  ...
  if (currentPlayerIsHeuristic(aiPlayer, room) && attacks.length > 0) {
    ...
    if (hasNuke || hasThermo) {
      ...
      if (bestLaunchTargetId && bestLaunchSourceId) {
        ...
        const RoomManager = require('./room-manager');
        RoomManager.sendAIChatMessage(room, io, aiPlayer, launchText, 'ðŸš€', false, '[AI]');
...
const PROPOSAL_TEMPLATES = {
  alliance: {
    ...
    kind: [
      "Hi @[target]! Would you like to be best friends and ally against @[subject]? ðŸ˜Š",
      "Let's help each other out and make an alliance against @[subject], @[target]! âœ¨",
      "If we team up in an alliance against @[subject], we can keep each other safe, @[target]! ðŸŒ¸",
      "Hey @[target]! Let's protect our lands together with an alliance against @[subject]! ðŸ’›",
      "Oh! Let's be sweet partners and keep @[subject] from being too scary, @[target]! ðŸ˜ŠðŸŒ¸",
      "Hi @[target]! Working together against @[subject] sounds so lovely! âœ¨",
      "Let's help each other stay happy and safe by allying against @[subject], @[target]! ðŸ’›",
      "I promise my little soldiers will be great allies against @[subject], @[target]! ðŸ‘",
      "Let's make a beautiful treaty and stand strong against @[subject]'s attacks, @[target]! ðŸ˜Š",
      "Hi @[target]! Sending warm thoughts! Let's coordinate happily against @[subject]! âœ¨",
      "Let's keep the peace between us and team up against @[subject], @[target]! ðŸŒ¸",
      "A sweet partnership is our best wish! Let's ally against @[subject], @[target]! ðŸ’›"
    ],
    goofball: [
      "Yo @[target], let's totally jump @[subject] together lmao ðŸ˜‚",
      "Alliance time! Let's make @[subject] cry in 4K, @[target] fr fr ðŸ’€",
      "Hey @[target]! Let's join the ultimate squad and wreck @[subject] haha!",
      "No cap @[target], let's team up in an alliance and take all of @[subject]'s stuff ðŸ˜­",
      "Lmfao @[target], let's go steal @[subject]'s lunch money and split it 50/50 ðŸ˜‚",
      "Yo @[target]! Let's pull up on @[subject] with the absolute squad lmfao! ðŸ’€",
      "Double trouble is active! RIP to @[subject], let's go run it down haha! ðŸ˜­",
      "Hey @[target]! Let's build a massive anti-@[subject] club and eat digital pizza! ðŸ˜‚",
      "No cap, we are about to end @[subject]'s whole career, team up bro! ðŸ’€",
      "Lmfao @[target], let's turn @[subject]'s sectors into a playground haha! ðŸ˜­",
      "Yo @[target]! Let's cooperate to make sure @[subject] gets absolute-unit reked! ðŸ˜‚",
      "Alliance activated! RIP to @[subject], you will not be missed lmfao! ðŸ’€"
    ],
    cynical: [
  ...
  non_aggression: {
    ...
    kind: [
      "Can we please sign a sweet ceasefire and declare peace, @[target]? ðŸ˜Š",
      "Let's make a lovely non-aggression truce and protect our borders, @[target]! âœ¨",
      "I propose a happy little ceasefire truce so we don't have to fight, @[target]! ðŸŒ¸",
      "Let's agree to mutual peace and ceasefire, @[target]! ðŸ’›",
      "Oh! Can we declare a sweet truce and be friendly neighbors, @[target]? ðŸ˜ŠðŸŒ¸",
      "Hi @[target]! I propose a happy little ceasefire so our soldiers stay safe! âœ¨",
      "Let's keep our borders beautiful and quiet with a peaceful ceasefire, @[target]! ðŸ’›",
      "A sweet non-aggression pact would make my little soldiers so happy, @[target]! ðŸ‘",
      "Sending warm wishes! Can we sign a happy ceasefire and be great friends, @[target]? ðŸ˜Š",
      "Hi @[target]! Sparing each other's feelings with a sweet truce sounds lovely! âœ¨",
      "Let's plant some flowers along our shared border and declare peace, @[target]! ðŸŒ¸",
      "I promise to be a kind neighbor! Let's sign a happy little ceasefire, @[target]! ðŸ’›"
    ],
    goofball: [
      "Hey @[target], let's chill and sign a ceasefire truce, no cap ðŸ’€",
      "Truce check! Let's agree to a ceasefire and eat virtual pizza instead, @[target] ðŸ˜‚",
      "Let's declare a non-aggression ceasefire so we can focus on being goofballs, @[target]!",
      "Ceasefire pact! Let's play nice and not punch each other, @[target] lmao ðŸ˜­",
      "Yo @[target], let's take a break from the fighting and sign a ceasefire lmfao! ðŸ˜‚",
      "Truce check active! Sparing our shared border is highly requested, no cap! ðŸ’€",
      "Let's sign a ceasefire so we can go watch the other players fight lmfao! ðŸ˜­",
      "Hey @[target], ceasefire pact! Let's be virtual high-five buddies instead! ðŸ˜‚",
      "No cap, let's lock in a ceasefire and do some side quests in the lobby lmfao! ðŸ’€",
      "Lmao ceasefire activated! Settle down and relax, @[target] haha! ðŸ˜­",
      "Let's agree to a truce so our little dudes don't get absolute-unit reked! ðŸ˜‚",
      "Lmfao truce signed! Time to chill out and eat virtual pizza lmfao bro! ðŸ’€"
    ],
    cynical: [
  ...
  move_troops: {
    ...
    kind: [
      "Would you mind terribly moving your cute little armies out of [requested_territory], @[target]? ðŸ˜Š",
      "Please withdraw your sweet troops from [requested_territory], @[target]! ðŸŒ¸",
      "Let's make [requested_territory] a peaceful zone and demilitarize it, @[target]! âœ¨",
      "Could you please vacate your soldiers from [requested_territory], @[target]? ðŸ’›",
      "Would you be so kind as to shift your little armies back from [requested_territory], @[target]? ðŸ˜ŠðŸŒ¸",
      "Please withdraw your sweet guard from [requested_territory], @[target]! Stay safe! âœ¨",
      "Let's keep [requested_territory] peaceful and move our soldiers away, @[target]! ðŸ’›",
      "Would you mind terribly relocating your armies away from [requested_territory], @[target]? ðŸ‘",
      "Please shift your brave troops back so we can keep our borders comfy, @[target]! ðŸ˜Š",
      "Could you please vacate your garrison from [requested_territory], sweet @[target]? âœ¨",
      "Sending warm thoughts! Please move your little dudes back from [requested_territory]! ðŸŒ¸",
      "I promise our intentions are friendly! Could you please clear [requested_territory], @[target]? ðŸ’›"
    ],
    goofball: [
      "Bro @[target], please get your loud armies out of [requested_territory] lmao ðŸ’€",
      "Hey @[target], move your little dudes out of [requested_territory] before they get lost haha!",
      "Can we demilitarize [requested_territory]? It's getting way too crowded, @[target] ðŸ˜­",
      "Please vacate [requested_territory], @[target]! My soldiers need their personal space ðŸ˜‚",
      "Lmao @[target], packing up the camper vans and vacating [requested_territory] is requested! ðŸ˜‚",
      "Hey @[target], shift your little dudes back so my squad can have some elbow room! ðŸ’€",
      "No cap, please clear out of [requested_territory] lmfao, it's super crowded! ðŸ˜­",
      "Lmfao @[target], move your armies before they start building sandcastles there! ðŸ˜‚",
      "Bro, please relocates your squad out of [requested_territory] lmfao, no cap! ðŸ’€",
      "Lmao alright, campsite relocation requested for [requested_territory], @[target]! haha! ðŸ˜­",
      "Hey @[target]! Move your little dudes back so we don't start any accidental drama! ðŸ˜‚",
      "Lmfao please vacate [requested_territory], @[target]! My soldiers are claustrophobic! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "Move your troops out of my sight! Sparing [requested_territory] is your only option! ðŸ˜¡",
  ...
  claim_territory: {
    ...
    kind: [
      "Could you please leave [requested_territory] to me, sweet @[target]? ðŸ˜Š",
      "I would be so happy if you stayed clear of [requested_territory], @[target]! ðŸŒ¸",
      "Please don't attack [requested_territory], let's keep it safe for my empire, @[target]! âœ¨",
      "Would you mind avoiding [requested_territory] on your next turn, @[target]? ðŸ’›",
      "Oh! Could you please spare [requested_territory] for my little empire, sweet @[target]? ðŸ˜ŠðŸŒ¸",
      "I would be so happy if you left [requested_territory] in our friendly hands! âœ¨",
      "Please don't advance into [requested_territory], let's keep things comfortable, @[target]! ðŸ’›",
      "Would you mind terribly bypassing [requested_territory] on your next turn, @[target]? ðŸ‘",
      "I promise to stay friendly! Please leave [requested_territory] to our home garden! ðŸ˜Š",
      "Hi @[target]! Sending love! Please stay clear of [requested_territory]! âœ¨",
      "Could you please avoid [requested_territory] so my little soldiers stay safe? ðŸŒ¸",
      "I would be so grateful if you spared [requested_territory], sweet neighbor! ðŸ’›"
    ],
    goofball: [
      "Stay clear of [requested_territory], @[target]! That's my exclusive gaming zone ðŸ’€",
      "Lmao do not touch [requested_territory], @[target]! It's mine fr fr ðŸ˜‚",
      "Hey @[target], please leave [requested_territory] alone, I already bought real estate there ðŸ˜­",
      "Don't cross into [requested_territory], @[target], or I'm calling the virtual police lmao!",
      "Lmao @[target], no touchy [requested_territory]! That's my private playground ðŸ˜‚",
      "Hey @[target]! Sparing [requested_territory] is highly requested, finders keepers bro! ðŸ’€",
      "Lmfao do not park your armies in [requested_territory], @[target]! It is fully booked! ðŸ˜­",
      "Don't expand into [requested_territory], @[target], or the boys are throwing hands lmfao! ðŸ˜‚",
      "Yo @[target], please steer clear of [requested_territory], no cap lmfao! ðŸ’€",
      "Lmao alright, [requested_territory] has terrible Wi-Fi anyway, avoid it bro! haha! ðŸ˜­",
      "No shot! Don't cross into [requested_territory], @[target]! That's my private fort! ðŸ˜‚",
      "Lmfao please leave [requested_territory] alone, I got a legendary scoreboard to climb! ðŸ˜­"
    ],
    cynical: [
    ...
    aggressive: [
      ...
      "I claim [requested_territory]! Sparing it is required if you value your capital! ðŸ˜¡",
